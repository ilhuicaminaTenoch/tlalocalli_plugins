...
class Essential_Grid_Dialogs {
		...
		<div id="pages-select-dialog-wrap" class="essential-dialog-wrap essential-dialog-padding esg-display-none" title="<?php esc_attr_e('Choose Pages', ESG_TEXTDOMAIN); ?>">
			...
			--><div class="esg-dialog-page-wrap"><input type="checkbox" id="check-uncheck-pages"><div class="space18"></div><?php esc_html_e('Select All', ESG_TEXTDOMAIN); ?></div><div class="div5"></div>
				<?php foreach($pages as $page) { $p = str_replace('"', '', $page->post_title) . ' (ID: ' . $page->ID . ')'; ?>
					<label></label><div class="esg-dialog-page-wrap"><input type="checkbox" value="<?php esc_attr_e($p); ?>" name="selected-pages"><div class="space18"></div><?php esc_html_e($p); ?></div><div class="div5"></div>
				<?php } ?>
	...
	public static function custom_element_image_dialog(){
		...
		<div id="custom-element-image-dialog-wrap" class="essential-dialog-wrap esg-display-none" title="<?php esc_attr_e('Add Images to Grid', ESG_TEXTDOMAIN); ?>">
			<?php _e('Please choose how you would like to add image(s) to the grid.<br>Single or bulk upload is possible', ESG_TEXTDOMAIN); ?>
			<div class="div13"></div><!--
	...
	public static function essgrid_add_shortcode_builder() {
		...
		$grids = Essential_Grid_Db::get_grids_short_vc();
		?>
				...
				<div id="esg-shortcode-settings" class="esg-settings-container active-esc">
					<div> <!-- BASIC SETTINGS -->
						...
						<div class="eg-cs-tbc eg-cs-tbc-no-border">
							<div class="esg-settings-grid-wrap">
								<label for="esg-sc-pregrid" class="eg-tooltip-wrap tooltipstered"><?php esc_html_e('Grid Base', ESG_TEXTDOMAIN); ?></label><!--
							...
							<div class="esg-settings-exset-wrap">
								<label for="esg-sc-existing-settings"><?php esc_html_e('Grid Base', ESG_TEXTDOMAIN); ?></label><!--
							...
							<div class="div13"></div>
							<label for="esg-sc-source" class="eg-tooltip-wrap tooltipstered"><?php esc_html_e('Content From', ESG_TEXTDOMAIN); ?></label><!--
							...
							<div id="eg-related-post-based-details">
								<div class="div13"></div>
								<label for="esg-sc-relatedbased" class="eg-tooltip-wrap tooltipstered"><?php esc_html_e('Related Post based on', ESG_TEXTDOMAIN); ?></label><!--
							...
							<div class="esgsettings-max-entries">
								<div class="div13"></div>
								<label for="esg-sc-max-entries"><?php esc_html_e('Maximum Entries', ESG_TEXTDOMAIN); ?></label><!--
					...
					<div id="esg_shortcode_custom_settings_bottom">
						...
						<div class="eg-cs-tbc eg-cs-tbc-shortcode-custom-settings-bottom">
							<label for="esg-sc-entry-skin"><?php esc_html_e('Grid Skin', ESG_TEXTDOMAIN); ?></label><!--
							...
							<div class="div13"></div>
							<label for="esg-sc-layout-sizing"><?php esc_html_e('Layout', ESG_TEXTDOMAIN); ?></label><!--
							...
							<div class="div13"></div>
							<label for="esg-sc-grid-layout"><?php esc_html_e('Grid Layout', ESG_TEXTDOMAIN); ?></label><!--
							...
							<div class="div13"></div>
							<label for="esg-sc-spacings"><?php esc_html_e('Item Spacing', ESG_TEXTDOMAIN); ?></label><!--
							--><input type="text" id="esg-sc-spacings" name="esg-sc-spacings" value="0" />
							<div class="div13"></div>
							<label for="esg-sc-rows-unlimited"><?php esc_html_e('Pagination', ESG_TEXTDOMAIN); ?></label><!--
							--><input type="radio" class="esg-margin-l-0" id="esg-sc-rows-unlimited" name="esg-sc-rows-unlimited" value="on" /><?php esc_html_e('Disable', ESG_TEXTDOMAIN); ?><div class="space18"></div><!--
							--><input type="radio" name="esg-sc-rows-unlimited" checked="checked" value="off" /><?php esc_html_e('Enable', ESG_TEXTDOMAIN); ?> 
							<div class="div13"></div>
							<label for="esg-sc-columns"><?php esc_html_e('Columns', ESG_TEXTDOMAIN); ?></label><!--
							--><input type="text" id="esg-sc-columns" name="esg-sc-columns" value="5" />
							<div class="div13"></div>
							<label for="esg-sc-rows"><?php esc_html_e('Max. Visible Rows', ESG_TEXTDOMAIN); ?></label><!--
							--><input type="text" id="esg-sc-rows" name="esg-sc-rows" value="3" />
							<div class="div13"></div>
							<label for="grid-animation-select"><?php esc_html_e('Start and Filter Animations', ESG_TEXTDOMAIN); ?></label><!--
							<?php
							...
							<div class="div13"></div>
							<label for="use_spinner"><?php esc_html_e('Choose Spinner', ESG_TEXTDOMAIN); ?></label><!--
		...
		<div id="esg_read_old_shortcode_dialog" class="essential-dialog-wrap essential-dialog-padding esg-display-none" title="<?php esc_attr_e('Read Shortcode', ESG_TEXTDOMAIN); ?>">
			<label for="esg_import_shortcode_text"><?php esc_html_e('Insert Shortcode', ESG_TEXTDOMAIN); ?></label><textarea class="esg-import-shortcode-text" id="esg_import_shortcode_text"></textarea>
		</div>
		...
		<div id="edit-custom-element-quick-dialog-wrap" class="essential-dialog-wrap essential-dialog-padding esg-display-none" title="<?php esc_attr_e('Custom Element Settings', ESG_TEXTDOMAIN); ?>">			
			...
			<div class="esg-item-skin-elements">
				<label for="esg-csi-title"><?php esc_html_e('Title', ESG_TEXTDOMAIN); ?></label><input type="text" id="esg-csi-title" value="" />
				...
				<div class="esg-csi-itemtype-html5">
					<div class="div13"></div>
					<label for="esg-csi-mp4"><?php esc_html_e('MP4 URL', ESG_TEXTDOMAIN); ?></label><input type="text" id="esg-csi-mp4" value="" />
				</div>
				<div class="esg-csi-itemtype-vimeo">
					<div class="div13"></div>
					<label for="esg-csi-vimeo"><?php esc_html_e('Vimeo ID', ESG_TEXTDOMAIN); ?></label><input type="text" id="esg-csi-vimeo" value="" />
				</div>
				<div class="esg-csi-itemtype-youtube">
					<div class="div13"></div>
					<label for="esg-csi-youtube"><?php esc_html_e('YouTube ID', ESG_TEXTDOMAIN); ?></label><input type="text" id="esg-csi-youtube" value="" />
				</div>
				<div class="esg-csi-itemtype-soundcloud">
					<div class="div13"></div>
					<label for="esg-csi-soundcloud"><?php esc_html_e('SoundCloud ID', ESG_TEXTDOMAIN); ?></label><input type="text" id="esg-csi-soundcloud" value="" />
				</div>
				<div class="esg-csi-itemtype-video">
					<div class="div13"></div>
					<label for="esg-csi-ratio"><?php esc_html_e('Video Ratio', ESG_TEXTDOMAIN); ?></label><!--
				...
				<div class="esg-csi-itemtype-cobbles">
					<div class="div13"></div>
					<label for="esg-csi-cobbles-size"><?php esc_html_e('Cobbles Element Size', ESG_TEXTDOMAIN); ?></label><!--
				...
				<div class="div13"></div>
				<label for="esg-csi-skin"><?php esc_html_e('Specific Skin', ESG_TEXTDOMAIN); ?></label><!--
			...
			<form id="edit-custom-element-form">
				...
				<div id="eg-custom-item-options">
					...
					<div id="esg-item-skin-elements-datas" class="eg-options-tab">
						...
						$p_lang = ['post' => esc_attr__('Item Data', ESG_TEXTDOMAIN), 'woocommerce' => esc_attr__('WooCommerce', ESG_TEXTDOMAIN)];
							...
							foreach($element as $handle => $itm){
								...
								switch($itm['type']) {
									...
									case 'image';
										...
										echo '<div class="esg-btn esg-purple eg-image-add" data-setto="eg-' . esc_attr($handle) . '-cm">' . esc_attr__('Choose Image', ESG_TEXTDOMAIN) . '</div> ';
										echo '<div class="esg-btn esg-red eg-image-clear" data-setto="eg-' . esc_attr($handle) . '-cm">' . esc_attr__('Remove Image', ESG_TEXTDOMAIN) . '</div>';
								...
								<?php
									switch($cmeta['type']){
										...
										case 'image':
											...
											<div class="esg-btn esg-purple eg-image-add" data-setto="eg-<?php echo esc_attr($cmeta['handle']).'-cm'; ?>"><?php esc_html_e('Choose Image', ESG_TEXTDOMAIN); ?></div>
											<div class="esg-btn esg-red eg-image-clear" data-setto="eg-<?php echo esc_attr($cmeta['handle']).'-cm'; ?>"><?php esc_html_e('Remove Image', ESG_TEXTDOMAIN); ?></div>
