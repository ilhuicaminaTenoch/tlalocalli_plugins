...
<ul id="eg-option-tabber-post-meta" class="eg-option-tabber-wrapper">
	...
	if ($disable_advanced) { 
		//only show if we are in preview mode
		?><li class="eg-option-tabber <?php echo esc_attr($selectedtab); ?>" data-target="#eg-my-cobbles-options"><span class="dashicons dashicons-align-center"></span><?php esc_html_e('Item Settings', ESG_TEXTDOMAIN); ?></li>
		<?php
		$selectedtab = "";
	} 
	?>
	<li class="eg-option-tabber <?php echo esc_attr($selectedtab); ?>" data-target="#eg-custommeta-options"><span class="dashicons dashicons-list-view"></span><?php esc_html_e('Custom Meta', ESG_TEXTDOMAIN); ?></li>
				...
				?>
					...
					switch($cmeta['type']){
						...
						case 'multi-select':
							...
							if(!empty($el) && is_array($el)){
								...
								foreach($el as $ele){
									...
									echo '<option value="'.esc_attr($ele).'"'.$sel.'>'.esc_html($ele).'</option>';
								}
							}
						...
						?><input type="hidden" value="<?php echo esc_attr($val); ?>" name="eg-<?php echo esc_attr($cmeta['handle']); ?>" id="eg-<?php echo esc_attr($cmeta['handle']); ?>" />
							<div class="esg-btn esg-purple eg-cm-image-add esg-margin-b-0" data-setto="eg-<?php echo esc_attr($cmeta['handle']); ?>"><?php esc_html_e('Choose Image', ESG_TEXTDOMAIN); ?></div><div class="space18"></div><!--
							--><div class="esg-btn esg-red eg-cm-image-clear esg-margin-b-0" data-setto="eg-<?php echo esc_attr($cmeta['handle']); ?>"><?php esc_html_e('Remove Image', ESG_TEXTDOMAIN); ?></div>
...
<div id="eg-source-options" class="eg-options-tab eg-source-options-tab">	
	...
	<div class="div13"></div>
	<label><?php esc_html_e('MP4 / Audio', ESG_TEXTDOMAIN); ?></label><input type="text" name="eg_sources_html5_mp4" id="eg_sources_html5_mp4" value="<?php echo esc_attr($eg_sources_html5_mp4); ?>" />
	<div class="div13"></div>
	...
	<div class="esg-custom-iblock-src-wrapper" >
		...
		<div class="div13"></div>
		<label for="eg_sources_youtube"><?php esc_html_e('YouTube ID', ESG_TEXTDOMAIN); ?></label><input type="text" name="eg_sources_youtube" id="eg_sources_youtube" value="<?php echo esc_attr($eg_sources_youtube); ?>" />
		<div class="div13"></div>
	...
	<div class="esg-custom-iblock-src-wrapper">
		...
		<div class="div13"></div>
		<label  for="eg_sources_vimeo"><?php esc_html_e('Vimeo ID', ESG_TEXTDOMAIN); ?></label><input type="text" name="eg_sources_vimeo" id="eg_sources_vimeo" value="<?php echo esc_attr($eg_sources_vimeo); ?>" />
		<div class="div13"></div>
		<label class="eg-mb-label eg-tooltip-wrap" title="<?php esc_attr_e('Choose the Video Ratio', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Video Ratio', ESG_TEXTDOMAIN); ?></label><!--
	...
	<div class="esg-custom-iblock-src-wrapper">
		...
		<div class="div13"></div>
		<label  for="eg_sources_wistia"><?php esc_html_e('Wistia ID', ESG_TEXTDOMAIN); ?></label><input type="text" name="eg_sources_wistia" id="eg_sources_wistia" value="<?php echo esc_attr($eg_sources_wistia); ?>" />
		<div class="div13"></div>
		<label class="eg-mb-label eg-tooltip-wrap" title="<?php esc_attr_e('Choose the Video Ratio', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Video Ratio', ESG_TEXTDOMAIN); ?></label><!--
	...
	<div class="esg-custom-iblock-src-wrapper">
		...
		<div class="div13"></div>
		<label for="eg_sources_soundcloud"><?php esc_html_e('SoundCloud Track ID', ESG_TEXTDOMAIN); ?></label><input type="text" name="eg_sources_soundcloud" id="eg_sources_soundcloud" value="<?php echo esc_attr($eg_sources_soundcloud); ?>" />
		<div class="div13"></div>
	...
	<div class="div13"></div>
	<label  for="eg_sources_image"><?php esc_html_e('Alt. Image', ESG_TEXTDOMAIN); ?></label><input type="text" name="eg_sources_image" id="eg_sources_image" class="esg-display-none" value="<?php echo esc_attr($eg_sources_image); ?>" /><!--
	...
	<div id="eg_sources_image-wrapper">
		<div class="div13"></div>
		<img id="eg_sources_image-img" src="<?php echo esc_url($eg_sources_image_url); ?>" alt="">
	</div>
	...
	<div class="esg-custom-iblock-src-wrapper">
		...
		<select id="eg_sources_essgrid" name="eg_sources_essgrid">
			...
			<?php 
				$_grids = Essential_Grid_Db::get_essential_grids();
