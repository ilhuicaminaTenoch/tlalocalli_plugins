...
//needs: $base (instance of Essential_Grid_Base), $grid (Instance of Essential_Grid_Db::get_essential_grid_by_id() || false [creation of new])
...
<form id="eg-form-create-settings">
	...
	<div>
		...
		<div class="eg-cs-tbc">
			...
			--><input type="radio" name="layout-sizing" value="boxed" <?php checked($base->getVar($grid, ['params', 'layout-sizing'], 'boxed'), 'boxed'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Grid always stays within the wrapping container', ESG_TEXTDOMAIN); ?>"><?php esc_html_e("Boxed", ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
			...
			--><input type="radio" name="layout-sizing" value="fullscreen" <?php checked($base->getVar($grid, ['params', 'layout-sizing'], 'boxed'), 'fullscreen'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Fullscreen Layout. !! Hides not needed options !! Grid Width = Window Width, Grid Height = Window Height - Offset Containers.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e("Fullscreen", ESG_TEXTDOMAIN); ?></span>
			...
			<div id="eg-even-masonry-wrap">
				...
				--><input type="radio" name="layout" value="even" <?php checked($base->getVar($grid, ['params', 'layout'], 'even'), 'even'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Even - Each item has same height. Width and height are item ratio dependent', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Even', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="layout" value="masonry" <?php checked($base->getVar($grid, ['params', 'layout'], 'even'), 'masonry'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Individual item height depends on media height and content height', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Masonry', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="layout" value="cobbles" <?php checked($base->getVar($grid, ['params', 'layout'], 'even'), 'cobbles'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Even Grid with Width / Height Multiplications', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Cobbles', ESG_TEXTDOMAIN); ?></span>           
				</div>
			</div>
			...
			<div id="eg-content-push-wrap">
				...
				--><input type="radio" name="content-push" value="on" <?php checked($base->getVar($grid, ['params', 'content-push'], 'off'), 'on'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Content will push the website down on Even Grids with content in the Masonry Content area for the last row', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="content-push" value="off" <?php checked($base->getVar($grid, ['params', 'content-push'], 'off'), 'off'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Content will overflow elements on Even Grids with content in the Masonry Content area for the last row', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
			</div>
			<div id="eg-items-ratio-wrap">
				...
				--><span id="eg-masonry-options"><input type="checkbox" name="auto-ratio" <?php checked($base->getVar($grid, ['params', 'auto-ratio'], 'true'), 'true'); ?> /> <?php esc_html_e('Auto', ESG_TEXTDOMAIN); ?></span>
			</div>
			<div class="div13"></div>
			<div>
				...
				--><input type="radio" name="rtl" value="on" <?php checked($base->getVar($grid, ['params', 'rtl'], 'off'), 'on'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Grid Items will be sorted and ordered from right to left', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="rtl" value="off" <?php checked($base->getVar($grid, ['params', 'rtl'], 'off'), 'off'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Grid Items will be sorted and ordered from left to right', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
			</div>
		</div>
	</div>
	...
	<div id="eg-cobbles-options">
		...
		<div class="eg-cs-tbc">
			...
			--><select name="show-even-on-device" >
					<option value="0"<?php selected($base->getVar($grid, ['params', 'show-even-on-device'], '0'), '0'); ?>><?php esc_html_e('Keep Cobbles Always', ESG_TEXTDOMAIN); ?></option>
					<option value="2"<?php selected($base->getVar($grid, ['params', 'show-even-on-device'], '0'), '2'); ?>><?php esc_html_e('Desktop Small and smaller', ESG_TEXTDOMAIN); ?></option>
					<option value="3"<?php selected($base->getVar($grid, ['params', 'show-even-on-device'], '0'), '3'); ?>><?php esc_html_e('Tablet Landscape and smaller', ESG_TEXTDOMAIN); ?></option>
					<option value="4"<?php selected($base->getVar($grid, ['params', 'show-even-on-device'], '0'), '4'); ?>><?php esc_html_e('Tablet and smaller', ESG_TEXTDOMAIN); ?></option>
					<option value="5"<?php selected($base->getVar($grid, ['params', 'show-even-on-device'], '0'), '5'); ?>><?php esc_html_e('Mobile Landscape and smaller', ESG_TEXTDOMAIN); ?></option>
					<option value="6"<?php selected($base->getVar($grid, ['params', 'show-even-on-device'], '0'), '6'); ?>><?php esc_html_e('Mobile', ESG_TEXTDOMAIN); ?></option>
				</select>
			</div>
			<div class="div13"></div>
		...
		--><input type="radio" name="use-cobbles-pattern" value="on" <?php checked($base->getVar($grid, ['params', 'use-cobbles-pattern'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('User cobbles pattern', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
		--><input type="radio" name="use-cobbles-pattern" value="off" <?php checked($base->getVar($grid, ['params', 'use-cobbles-pattern'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('User specific set cobbles setting from entries', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
			...
			<div>
				<a class="esg-btn esg-purple eg-add-new-cobbles-pattern eg-tooltip-wrap<?php echo ($base->getVar($grid, ['params', 'use-cobbles-pattern'], 'off') == 'off') ? ' esg-display-none' : ''; ?>" title="<?php esc_attr_e('Add your custom cobbles pattern here', ESG_TEXTDOMAIN); ?>" href="javascript:void(0);"><i class="eg-icon-plus"></i><?php esc_html_e("Cobbles Pattern", ESG_TEXTDOMAIN); ?></a>
				<a class="esg-refresh-preview-button eg-refresh-cobbles-pattern esg-btn esg-blue<?php echo ($base->getVar($grid, ['params', 'use-cobbles-pattern'], 'off') == 'off') ? ' esg-display-none' : ''; ?>"><i class="eg-icon-arrows-ccw"></i><?php esc_html_e('Refresh Preview', ESG_TEXTDOMAIN); ?></a>
			</div>
		</div>
	</div>
	...
	<div>
		...
		<div class="eg-cs-tbc">
			...
			--><tr id="eg-col-0"><!--
				...
				--><input type="radio" name="columns-advanced" value="off" <?php checked($base->getVar($grid, ['params', 'columns-advanced'], 'off'), 'off'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Simple columns. Each row with same column, default media query levels.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Simple', ESG_TEXTDOMAIN); ?></span>
				</td>
				<td></td>
			</tr>
			...
			foreach ($devices as $k => $v) {
				...
				<tr id="eg-col-<?php echo $k+1; ?>">
					<td class="eg-tooltip-wrap" title="<?php echo esc_attr($title['label']); ?>"><label><?php esc_html_e($v['label'], ESG_TEXTDOMAIN); ?></label></td>
					<td><!--
					...
					<td class="eg-tooltip-wrap esg-adv-row-title-span-small" title="<?php echo esc_attr($title['columns']); ?>"><input class="input-settings-small" type="text" id="columns-<?php echo $k+1; ?>" name="columns[]" value="<?php echo esc_attr($columns[$k]); ?>" /></td>
					<?php
					if (!empty($columns_advanced)) {
						foreach ($columns_advanced as $adv_key => $adv) {
							if(empty($adv)) continue;
	...
	<div class=" eg-blankitem-hideable">
		...
		<div class="eg-cs-tbc">         
			...
			--><?php $blank_breakpoint = $base->getVar($grid, ['params', 'blank-item-breakpoint'], 'none'); ?><select class="eg-tooltip-wrap" name="blank-item-breakpoint" title="<?php esc_attr_e('Hide Blank Items at a certain break-point', ESG_TEXTDOMAIN); ?>">
	...
	<div>
		...
		<div class="eg-cs-tbc">
			<div id="eg-pagination-wrap">
				...
				--><input type="radio" name="rows-unlimited" value="on" <?php checked($base->getVar($grid, ['params', 'rows-unlimited'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Pagination deactivated. Load More Option is available.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Disable (Load More Available)', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="rows-unlimited" value="off" <?php checked($base->getVar($grid, ['params', 'rows-unlimited'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Pagination Activated. Load More Option is disabled. Dont Forget to add The Navigation Module "Pagination" to your Grid !', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Enable', ESG_TEXTDOMAIN); ?></span>
			</div>
			<div class="rows-num-wrap<?php echo ($base->getVar($grid, ['params', 'rows-unlimited'], 'off') == 'on') ? ' esg-display-none' : ''; ?>">           
				...
				--><span id="slider-rows" class="slider-settings"></span><div class="space18"></div><input class="input-settings-small" type="text" name="rows" value="<?php echo $base->getVar($grid, ['params', 'rows'], '3', 'i'); ?>" />
				<div class="div13"></div>           
				...
				--><input type="radio" class=" enable-mobile-rows" name="enable-rows-mobile" value="on" <?php checked($base->getVar($grid, ['params', 'enable-rows-mobile'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Enable custom rows amount for mobile devices', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Enable', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" class="enable-mobile-rows" name="enable-rows-mobile" value="off" <?php checked($base->getVar($grid, ['params', 'enable-rows-mobile'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Disable custom rows amount for mobile devices', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Disable', ESG_TEXTDOMAIN); ?></span>           
				...
				--><input type="radio" class="pagination-autoplay" name="pagination-autoplay" value="on" <?php checked($base->getVar($grid, ['params', 'pagination-autoplay'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Enable Autoplay for Pagination', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Enable', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" class="pagination-autoplay" name="pagination-autoplay" value="off" <?php checked($base->getVar($grid, ['params', 'pagination-autoplay'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Disable Autoplay for Pagination', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Disable', ESG_TEXTDOMAIN); ?></span>
				...
				--><input type="radio" class="pagination-touchswipe" name="pagination-touchswipe" value="off" <?php checked($base->getVar($grid, ['params', 'pagination-touchswipe'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Disable TouchSwipe for Pagination', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Disable', ESG_TEXTDOMAIN); ?></span>                      
				<div id="pagination-touchswipe-settings"<?php echo ($base->getVar($grid, ['params', 'pagination-touchswipe'], 'off') == 'off') ? ' class="esg-display-none" ' : ''; ?>>
					...
					--><input type="radio" class="pagination-dragvertical" name="pagination-dragvertical" value="off" <?php checked($base->getVar($grid, ['params', 'pagination-dragvertical'], 'on'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Prevent Vertical Dragging', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Disable', ESG_TEXTDOMAIN); ?></span>               
					<div class="div13"></div>
		...
		<div class="eg-cs-tbc">
			<div class="load-more-wrap<?php echo ($base->getVar($grid, ['params', 'rows-unlimited'], 'off') == 'off') ? ' esg-display-none' : ''; ?>">
				...
				--><select name="load-more" >
					<option value="none"<?php selected($base->getVar($grid, ['params', 'load-more'], 'none'), 'none'); ?>><?php esc_html_e('None', ESG_TEXTDOMAIN); ?></option>
					<option value="button"<?php selected($base->getVar($grid, ['params', 'load-more'], 'none'), 'button'); ?>><?php esc_html_e('More Button', ESG_TEXTDOMAIN); ?></option>
					<option value="scroll"<?php selected($base->getVar($grid, ['params', 'load-more'], 'none'), 'scroll'); ?>><?php esc_html_e('Infinite Scroll', ESG_TEXTDOMAIN); ?></option>
				</select>
			</div>
			<div class="load-more-wrap load-more-hide-wrap<?php echo ($base->getVar($grid, ['params', 'rows-unlimited'], 'off') == 'off' || $base->getVar($grid, ['params', 'load-more'], 'none') !== 'scroll') ? ' esg-display-none' : ''; ?>">
				...
				--><input type="radio" name="load-more-hide" value="on" <?php checked($base->getVar($grid, ['params', 'load-more-hide'], 'off'), 'on'); ?>><?php esc_html_e('On', ESG_TEXTDOMAIN); ?><div class="space18"></div><!--
				--><input type="radio" name="load-more-hide" value="off" <?php checked($base->getVar($grid, ['params', 'load-more-hide'], 'off'), 'off'); ?>><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?>
			</div>
			<div class="load-more-wrap<?php echo ($base->getVar($grid, ['params', 'rows-unlimited'], 'off') == 'off') ? ' esg-display-none' : ''; ?>">
				<div class="div13"></div>
				...
				--><input type="text" name="load-more-text" value="<?php echo esc_attr($base->getVar($grid, ['params', 'load-more-text'], esc_attr__('Load More', ESG_TEXTDOMAIN))); ?>" />
			</div>
			<div class="load-more-wrap<?php echo ($base->getVar($grid, ['params', 'rows-unlimited'], 'off') == 'off') ? ' esg-display-none' : ''; ?>">
				<div class="div13"></div>
			...
			<div class="load-more-wrap<?php echo ($base->getVar($grid, ['params', 'rows-unlimited'], 'off') == 'off') ? ' esg-display-none' : ''; ?>">
				...
				--><input type="radio" name="load-more-show-number" value="on" <?php checked($base->getVar($grid, ['params', 'load-more-show-number'], 'on'), 'on'); ?>><?php esc_html_e('On', ESG_TEXTDOMAIN); ?><div class="space18"></div><!--
				--><input type="radio" name="load-more-show-number" value="off" <?php checked($base->getVar($grid, ['params', 'load-more-show-number'], 'on'), 'off'); ?>><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?>
			</div>
			<div class="load-more-wrap<?php echo ($base->getVar($grid, ['params', 'rows-unlimited'], 'off') == 'off') ? ' esg-display-none' : ''; ?>">
				<div class="div13"></div>
			...
			--><input type="radio" name="lazy-loading" value="on" <?php checked($base->getVar($grid, ['params', 'lazy-loading'], 'off'), 'on'); ?>><span class=" eg-tooltip-wrap" title="<?php esc_attr_e('Enable Lazy Load of Items', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
			--><input type="radio" name="lazy-loading" value="off" <?php checked($base->getVar($grid, ['params', 'lazy-loading'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Disable Lazy Loading (All Item except the - Load more items -  on first page will be preloaded once)', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
			<div class="div13"></div>
			<label for="lazy-loading"><?php esc_html_e('Lazy Load Blurred Image', ESG_TEXTDOMAIN); ?></label><!--
			--><input type="radio" name="lazy-loading-blur" value="on" <?php checked($base->getVar($grid, ['params', 'lazy-loading-blur'], 'on'), 'on'); ?>><span class=" eg-tooltip-wrap" title="<?php esc_attr_e('Enable Lazy Load Blurred Images, that will be shown before the selected image is loaded', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
			--><input type="radio" name="lazy-loading-blur" value="off" <?php checked($base->getVar($grid, ['params', 'lazy-loading-blur'], 'on'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Disabled Lazy Load Blurred Images, that will be shown before the selected image is loaded', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>         
	...
	<div>
		...
		<div class="eg-cs-tbc">
			...
			--><span class="esg-display-inline-block"><input class="eg-tooltip-wrap input-settings-small" title="<?php esc_attr_e('Grid Padding Top', ESG_TEXTDOMAIN); ?>" type="text" name="grid-padding[]" value="<?php echo esc_attr($base->getVar($grid_padding, 0)); ?>" /> px</span><div class="space18"></div><!--          
			--><span class="esg-display-inline-block"><input class="eg-tooltip-wrap input-settings-small" title="<?php esc_attr_e('Grid Padding Right', ESG_TEXTDOMAIN); ?>" type="text" name="grid-padding[]" value="<?php echo esc_attr($base->getVar($grid_padding, 1)); ?>" /> px</span><div class="space18"></div><!--      
			--><span class="esg-display-inline-block"><input class="eg-tooltip-wrap input-settings-small" title="<?php esc_attr_e('Grid Padding Bottom', ESG_TEXTDOMAIN); ?>" type="text" name="grid-padding[]" value="<?php echo esc_attr($base->getVar($grid_padding, 2)); ?>" /> px</span><div class="space18"></div><!--
			--><span class="esg-display-inline-block"><input class="eg-tooltip-wrap input-settings-small" title="<?php esc_attr_e('Grid Padding Left', ESG_TEXTDOMAIN); ?>" type="text" name="grid-padding[]" value="<?php echo esc_attr($base->getVar($grid_padding, 3)); ?>" /> px</span><div class="space18"></div>
		</div>
	</div>
	</div>
		...
		<div>
			...
			<div class="eg-cs-tbc"> 
				<div class="esg-showhidegroup">
					...
					--><span class="grid-item-anime-wrap-zoomin grid-item-anime-option"><input id="grid-item-animation-zoomin" class="input-settings-small eg-tooltip-wrap" type="text" name="grid-item-animation-zoomin" value="<?php echo esc_attr($base->getVar($grid, ['params', 'grid-item-animation-zoomin'], '125')); ?>" title="<?php esc_attr_e('Zoom In Percentage (100-200)', ESG_TEXTDOMAIN); ?>" /> %</span><!--
					--><span class="grid-item-anime-wrap-zoomout grid-item-anime-option"><input id="grid-item-animation-zoomout" class="input-settings-small eg-tooltip-wrap" type="text" name="grid-item-animation-zoomout" value="<?php echo esc_attr($base->getVar($grid, ['params', 'grid-item-animation-zoomout'], '75')); ?>" title="<?php esc_attr_e('Zoom Out Percentage (0-100)', ESG_TEXTDOMAIN); ?>" /> %</span><!--
					--><span class="grid-item-anime-wrap-fade grid-item-anime-option"><input id="grid-item-animation-fade" class="input-settings-small eg-tooltip-wrap" type="text" name="grid-item-animation-fade" value="<?php echo esc_attr($base->getVar($grid, ['params', 'grid-item-animation-fade'], '75')); ?>" title="<?php esc_attr_e('Fade Percentage (0-100)', ESG_TEXTDOMAIN); ?>" /> %</span><!--
					--><span class="grid-item-anime-wrap-blur grid-item-anime-option"><input id="grid-item-animation-blur" class="input-settings-small eg-tooltip-wrap" type="text" name="grid-item-animation-blur" value="<?php echo esc_attr($base->getVar($grid, ['params', 'grid-item-animation-blur'], '5')); ?>" title="<?php esc_attr_e('Blur Amount (0-20)', ESG_TEXTDOMAIN); ?>" /> px</span><!--
					--><span class="grid-item-anime-wrap-rotate grid-item-anime-option"><input id="grid-item-animation-rotate" class="input-settings-small eg-tooltip-wrap" type="text" name="grid-item-animation-rotate" value="<?php echo esc_attr($base->getVar($grid, ['params', 'grid-item-animation-rotate'], '30')); ?>" title="<?php esc_attr_e('Blur Amount (0-360)', ESG_TEXTDOMAIN); ?>" /> deg</span><!--
				...
				<div class="esg-showhidegroup">
					...
					--><span class="grid-item-anime-wrap-zoomin grid-item-anime-option"><input id="grid-item-other-zoomin" class="input-settings-small eg-tooltip-wrap" type="text" name="grid-item-other-zoomin" value="<?php echo esc_attr($base->getVar($grid, ['params', 'grid-item-other-zoomin'], '125')); ?>" title="<?php esc_attr_e('Zoom In Percentage (100-200)', ESG_TEXTDOMAIN); ?>" /> %</span><!--
					--><span class="grid-item-anime-wrap-zoomout grid-item-anime-option"><input id="grid-item-other-zoomout" class="input-settings-small eg-tooltip-wrap" type="text" name="grid-item-other-zoomout" value="<?php echo esc_attr($base->getVar($grid, ['params', 'grid-item-other-zoomout'], '75')); ?>" title="<?php esc_attr_e('Zoom Out Percentage (0-100)', ESG_TEXTDOMAIN); ?>" /> %</span><!--
					--><span class="grid-item-anime-wrap-fade grid-item-anime-option"><input id="grid-item-other-fade" class="input-settings-small eg-tooltip-wrap" type="text" name="grid-item-other-fade" value="<?php echo esc_attr($base->getVar($grid, ['params', 'grid-item-other-fade'], '75')); ?>" title="<?php esc_attr_e('Fade Percentage (0-100)', ESG_TEXTDOMAIN); ?>" /> %</span><!--
					--><span class="grid-item-anime-wrap-blur grid-item-anime-option"><input id="grid-item-other-blur" class="input-settings-small eg-tooltip-wrap" type="text" name="grid-item-other-blur" value="<?php echo esc_attr($base->getVar($grid, ['params', 'grid-item-other-blur'], '5')); ?>" title="<?php esc_attr_e('Blur Amount (0-20)', ESG_TEXTDOMAIN); ?>" /> px</span><!--
					--><span class="grid-item-anime-wrap-rotate grid-item-anime-option"><input id="grid-item-other-rotate" class="input-settings-small eg-tooltip-wrap" type="text" name="grid-item-other-rotate" value="<?php echo esc_attr($base->getVar($grid, ['params', 'grid-item-other-rotate'], '30')); ?>" title="<?php esc_attr_e('Blur Amount (0-360)', ESG_TEXTDOMAIN); ?>" /> deg</span><!--
					--><span class="grid-item-anime-wrap-shift grid-item-anime-option"><select name="grid-item-other-shift" >
						...
						</select><div class="space18"></div><input id="grid-item-other-shift-amount" class="input-settings-small eg-tooltip-wrap" type="text" name="grid-item-other-shift-amount" value="<?php echo esc_attr($base->getVar($grid, ['params', 'grid-item-other-shift-amount'], '10')); ?>" title="<?php esc_attr_e('Shift Amount in pixels', ESG_TEXTDOMAIN); ?>" /> px
					</span>
				</div>
			</div>
		</div>
	...
	<div id="esg-settings-filterandco-settings" class="esg-settings-container">
				...
				<div class="esg-msow-inner">
					<div>
						...
						<div class="eg-navigation-cons-wrapper eg-tooltip-wrap eg-navigation-default-wrap" title="<?php esc_attr_e('Drag and Drop Navigation Modules into the Available Drop Zones', ESG_TEXTDOMAIN); ?>">
							...
							<div data-navtype="pagination" class="eg-navigation-cons-pagination eg-navigation-cons"<?php echo (isset($layout['pagination']) && $layout['pagination'] !== '') ? ' data-putin="'.esc_attr(current(array_keys($layout['pagination']))).'" data-sort="'.esc_attr($layout['pagination'][current(array_keys($layout['pagination']))]).'"' : ''; ?>><i class="eg-icon-doc-inv"></i><?php esc_html_e("Pagination", ESG_TEXTDOMAIN); ?></div>
							<div data-navtype="filter" class="eg-navigation-cons-filter eg-navigation-cons"<?php echo (isset($layout['filter']) && $layout['filter'] !== '') ? ' data-putin="'.esc_attr(current(array_keys($layout['filter']))).'" data-sort="'.esc_attr($layout['filter'][current(array_keys($layout['filter']))]).'"' : ''; ?>><i class="eg-icon-megaphone"></i><?php esc_html_e("Filter 1", ESG_TEXTDOMAIN); ?></div>
							<?php if (Essential_Grid_Woocommerce::is_woo_exists()) { ?>
							<div data-navtype="cart" class="eg-navigation-cons-cart eg-navigation-cons"<?php echo (isset($layout['cart']) && $layout['cart'] !== '') ? ' data-putin="'.esc_attr(current(array_keys($layout['cart']))).'" data-sort="'.esc_attr($layout['cart'][current(array_keys($layout['cart']))]).'"' : ''; ?>><i class="eg-icon-basket"></i><?php esc_html_e("Cart", ESG_TEXTDOMAIN); ?></div>
							<?php }
							...
							if (!empty($layout)) {
								foreach ($layout as $key => $val) {
									if (strpos($key, 'filter-') !== false) {
										...
										?>
										<div data-navtype="filter-<?php echo $nr; ?>" class="eg-navigation-cons-filter-<?php echo $nr; ?> eg-nav-cons-filter eg-navigation-cons"<?php echo ' data-putin="'.esc_attr(current(array_keys($layout[$key]))).'" data-sort="'.esc_attr($layout[$key][current(array_keys($layout[$key]))]).'"'; ?>><i class="eg-icon-megaphone"></i><?php esc_html_e("Filter", ESG_TEXTDOMAIN); echo ' '.$nr; ?></div>
										<?php
									}
								}
							}
							?>
							<div data-navtype="sort" class="eg-navigation-cons-sort eg-navigation-cons"<?php echo (isset($layout['sorting']) && $layout['sorting'] !== '') ? ' data-putin="'.esc_attr(current(array_keys($layout['sorting']))).'" data-sort="'.esc_attr($layout['sorting'][current(array_keys($layout['sorting']))]).'"' : ''; ?>><i class="eg-icon-sort-name-up"></i><?php esc_html_e("Sort", ESG_TEXTDOMAIN); ?></div>
		...
		<div>
			...
			<div class="eg-cs-tbc">
				...
				--><input type="radio" name="top-1-align" value="left" <?php checked($base->getVar($grid, ['params', 'top-1-align'], 'center'), 'left'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('All Buttons in this Zone Align to the left', ESG_TEXTDOMAIN); ?>" ><?php esc_html_e("Left", ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="top-1-align" value="center" <?php checked($base->getVar($grid, ['params', 'top-1-align'], 'center'), 'center'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('All Buttons in this Zone Align to Center', ESG_TEXTDOMAIN); ?>" ><?php esc_html_e("Center", ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="top-1-align" value="right" <?php checked($base->getVar($grid, ['params', 'top-1-align'], 'center'), 'right'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('All Buttons in this Zone Align to the Right', ESG_TEXTDOMAIN); ?>"><?php esc_html_e("Right", ESG_TEXTDOMAIN); ?></span><div class="space36"></div><!--
				...
				--><input type="radio" name="top-2-align" value="left" <?php checked($base->getVar($grid, ['params', 'top-2-align'], 'center'), 'left'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('All Buttons in this Zone Align to the left', ESG_TEXTDOMAIN); ?>"><?php esc_html_e("Left", ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="top-2-align" value="center" <?php checked($base->getVar($grid, ['params', 'top-2-align'], 'center'), 'center'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('All Buttons in this Zone Align to Center', ESG_TEXTDOMAIN); ?>"><?php esc_html_e("Center", ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="top-2-align" value="right" <?php checked($base->getVar($grid, ['params', 'top-2-align'], 'center'), 'right'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('All Buttons in this Zone Align to the Right', ESG_TEXTDOMAIN); ?>"><?php esc_html_e("Right", ESG_TEXTDOMAIN); ?></span><div class="space36"></div><!--
				--><span class="eg-tooltip-wrap esg-dropzone-margin-label" title="<?php esc_attr_e('Space under the Zone', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Margin Bottom', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				...
				--><input type="radio" name="bottom-1-align" value="left" <?php checked($base->getVar($grid, ['params', 'bottom-1-align'], 'center'), 'left'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('All Buttons in this Zone Align to the left', ESG_TEXTDOMAIN); ?>"><?php esc_html_e("Left", ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="bottom-1-align" value="center" <?php checked($base->getVar($grid, ['params', 'bottom-1-align'], 'center'), 'center'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('All Buttons in this Zone Align to Center', ESG_TEXTDOMAIN); ?>"><?php esc_html_e("Center", ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="bottom-1-align" value="right" <?php checked($base->getVar($grid, ['params', 'bottom-1-align'], 'center'), 'right'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('All Buttons in this Zone Align to the Right', ESG_TEXTDOMAIN); ?>"><?php esc_html_e("Right", ESG_TEXTDOMAIN); ?></span><div class="space36"></div><!--
				...
				--><input type="radio" name="bottom-2-align" value="left" <?php checked($base->getVar($grid, ['params', 'bottom-2-align'], 'center'), 'left'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('All Buttons in this Zone Align to the left', ESG_TEXTDOMAIN); ?>"><?php esc_html_e("Left", ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="bottom-2-align" value="center" <?php checked($base->getVar($grid, ['params', 'bottom-2-align'], 'center'), 'center'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('All Buttons in this Zone Align to Center', ESG_TEXTDOMAIN); ?>"><?php esc_html_e("Center", ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="bottom-2-align" value="right" <?php checked($base->getVar($grid, ['params', 'bottom-2-align'], 'center'), 'right'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('All Buttons in this Zone Align to the Right', ESG_TEXTDOMAIN); ?>"><?php esc_html_e("Right", ESG_TEXTDOMAIN); ?></span><div class="space36"></div><!--
				--><span class="eg-tooltip-wrap esg-dropzone-margin-label" title="<?php esc_attr_e('Space above the Zone', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Margin Top', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
		...
		<div>
			...
			<div class="eg-cs-tbc">
				...
				--><input type="radio" name="pagination-numbers" value="smart" <?php checked($base->getVar($grid, ['params', 'pagination-numbers'], 'smart'), 'smart'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Will show pagination like: 1 2 ... 5 6', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Smart', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="pagination-numbers" value="full" <?php checked($base->getVar($grid, ['params', 'pagination-numbers'], 'smart'), 'full'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Will show full pagination like: 1 2 3 4 5 6', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Full', ESG_TEXTDOMAIN); ?></span>
				<div class="div13"></div>
				<label for="pagination-scroll"><?php esc_html_e('Scroll To Top', ESG_TEXTDOMAIN); ?></label><!--
				--><input type="radio" name="pagination-scroll" value="on" <?php checked($base->getVar($grid, ['params', 'pagination-scroll'], 'off'), 'on'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Scroll to top if pagination is clicked', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="pagination-scroll" value="off" <?php checked($base->getVar($grid, ['params', 'pagination-scroll'], 'off'), 'off'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Do nothing if pagination is clicked', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
		...
		<div class="filter_groups">
			...
			<div class="eg-cs-tbc">
				...
				--><input type="radio" name="filter-arrows" value="single" <?php checked($base->getVar($grid, ['params', 'filter-arrows'], 'single'), 'single'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Filter is based on 1 Selected Filter in same time.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Single', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="filter-arrows" value="multi" <?php checked($base->getVar($grid, ['params', 'filter-arrows'], 'single'), 'multi'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Filter is based on 1 or more Filters in same time.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Multiple', ESG_TEXTDOMAIN); ?></span>           
				<div class="eg-filter-logic esg-display-none">
					<div class="div13"></div>
					<label for="filter-logic"><?php esc_html_e('Filter Logic', ESG_TEXTDOMAIN); ?></label><!--
					--><input type="radio" name="filter-logic" value="and" <?php checked($base->getVar($grid, ['params', 'filter-logic'], 'or'), 'and'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Shows all elements that meet ONE OR MORE of the selected filters', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('AND', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
					--><input type="radio" name="filter-logic" value="or" <?php checked($base->getVar($grid, ['params', 'filter-logic'], 'or'), 'or'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Shows all elements that meet ALL of the selected filters', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('OR', ESG_TEXTDOMAIN); ?></span>
				</div>
				<div id="add_filters_by">
					<div class="div13"></div>
					<label for="add-filters-by"><?php esc_html_e('Add Filters By', ESG_TEXTDOMAIN); ?></label><!--
					--><input type="radio" name="add-filters-by" value="default" <?php checked($base->getVar($grid, ['params', 'add-filters-by'], 'default'), 'default'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Combine tags and categories', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Default', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
					--><input type="radio" name="add-filters-by" value="categories" <?php checked($base->getVar($grid, ['params', 'add-filters-by'], 'default'), 'categories'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Only categories', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Categories', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
					--><input type="radio" name="add-filters-by" value="tags" <?php checked($base->getVar($grid, ['params', 'add-filters-by'], 'default'), 'tags'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Only tags', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Tags', ESG_TEXTDOMAIN); ?></span>
				</div>
				...
				--><input type="radio" name="filter-deep-link" value="on" <?php checked($base->getVar($grid, ['params', 'filter-deep-link'], 'off'), 'on'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Deep Linking with #slug possible', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="filter-deep-link" value="off" <?php checked($base->getVar($grid, ['params', 'filter-deep-link'], 'off'), 'off'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('No Deep Linking with #slug', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
			
				<div class="div13"></div>
				<label for="filter-show-on"><?php esc_html_e('Dropdown Elements on', ESG_TEXTDOMAIN); ?></label><!--
				--><input type="radio" name="filter-show-on" value="click" <?php checked($base->getVar($grid, ['params', 'filter-show-on'], 'hover'), 'click'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Filter in Dropdown will be shown on click', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Click', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="filter-show-on" value="hover" <?php checked($base->getVar($grid, ['params', 'filter-show-on'], 'hover'), 'hover'); ?>> <span class="eg-tooltip-wrap" title="<?php esc_attr_e('Filter in Dropdown will be shown on hover', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Hover', ESG_TEXTDOMAIN); ?></span>
				...
				<div class="eg-original-filter-options-holder">
					...
					function eg_filter_tab_function($id, $grid, $base, $wrap_class = 'eg-filter-options-wrap-clone')
					{
						...
						$filter_all_text = $base->getVar( $grid, ['params', 'filter-all-text' . $f_id], esc_attr__( 'Filter - All', ESG_TEXTDOMAIN ) );
						$filter_listing = $base->getVar($grid, ['params', 'filter-listing' . $f_id], 'list');
						$filter_dropdown_text = $base->getVar($grid, ['params', 'filter-dropdown-text' . $f_id], esc_attr__('Filter Categories', ESG_TEXTDOMAIN));
						...
						<div class="eg-filter-options-wrap <?php echo esc_attr($wrap_class); ?>">
							<div class="eg-filter-header-block">
								<i class="eg-icon-megaphone"></i><?php esc_html_e('Filter -', ESG_TEXTDOMAIN); ?>
							...
							<div class="eg-filter-option-field">
								<input type="radio" name="filter-all-visible<?php echo $f_id; ?>" data-origname="filter-all-visible-#NR" value="on" class=" filtervisible filter-all-first" <?php checked($filterallon, 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Show the Filter All button', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Show', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
								--><input type="radio" name="filter-all-visible<?php echo $f_id; ?>" data-origname="filter-all-visible-#NR" value="off" class="filtervisible" <?php checked($filterallon, 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Hide the Filter All button', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Hide', ESG_TEXTDOMAIN); ?></span>
							</div>
							...
							<div class="eg-filter-visible esg-display-<?php echo $filtervisible; ?>">
								...
								<div class="eg-filter-option-field eg-tooltip-wrap" title="<?php esc_attr_e('Visible Title for the ALL Filter Button', ESG_TEXTDOMAIN); ?>">
									<input type="text" name="filter-all-text<?php echo $f_id; ?>" data-origname="filter-all-text-#NR" value="<?php echo esc_attr($filter_all_text); ?>" >
							...
							<div class="eg-filter-option-field">
								<select class="filter-listing-type" name="filter-listing<?php echo $f_id; ?>" data-origname="filter-listing-#NR">
							...
							<div class="filter-only-if-dropdown">
								...
								<div class="eg-filter-option-field eg-tooltip-wrap" title="<?php esc_attr_e('Default Text on the Filter Dropdown List.', ESG_TEXTDOMAIN); ?>">
									<input type="text" name="filter-dropdown-text<?php echo $f_id; ?>" data-origname="filter-dropdown-text-#NR" value="<?php echo esc_attr($filter_dropdown_text); ?>" />
								</div>
							</div>
							<div class="eg-filter-label"><?php esc_html_e('Show Number of Elements', ESG_TEXTDOMAIN); ?></div>
							<div class="eg-filter-option-field">
								<select name="filter-counter<?php echo $f_id; ?>" data-origname="filter-counter-#NR">
									<option value="on" <?php selected($filter_counter, 'on'); ?>><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></option>
									<option value="off" <?php selected($filter_counter, 'off'); ?>><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></option>
								</select>
							</div>
							<div class="eg-filter-label"><?php esc_html_e('Sort Filters Alphabetically', ESG_TEXTDOMAIN); ?></div>
							<div class="eg-filter-option-field">
								<select class="filter-sort-alpha" name="filter-sort-alpha<?php echo $f_id; ?>" data-origname="filter-sort-alpha-#NR">
							...
							<div class="filter-only-if-sort">
								...
								<div class="eg-filter-option-field">
									<select name="filter-sort-alpha-dir<?php echo $f_id; ?>" data-origname="filter-sort-alpha-dir-#NR">
							...
							<div class="eg-filter-label available-filters-in-group">
								<?php esc_html_e('Available Filters in Group', ESG_TEXTDOMAIN); ?>
								<div class="esg-f-right">
									<div class="eg-tooltip-wrap esg-display-inline-block esg-margin-r-5" title="<?php esc_attr_e('Select All', ESG_TEXTDOMAIN); ?>">
										<input data-items=".eg-filter-selected<?php echo $f_id; ?>" class="eg-get-val eg-filter-input select-all-available-filters-in-group" type="checkbox" checked />
									</div>
									<div class="eg-tooltip-wrap esg-display-inline-block esg-margin-r-5" title="<?php esc_attr_e('Deselect All', ESG_TEXTDOMAIN); ?>">
										<input data-items=".eg-filter-selected<?php echo $f_id; ?>" class="eg-get-val eg-filter-input deselect-all-available-filters-in-group" type="checkbox" />
									</div>
								</div>
							</div>
							<div class="esg-margin-t-10">
								<div class="eg-media-source-order-wrap eg-filter-selected-order-wrap<?php echo $f_id; ?>">
								<?php foreach ($filter_selected as $fs) { ?>
									<div class="eg-media-source-order esg-blue esg-btn">
										<span><?php echo esc_html($fs); ?></span>
										<input class="eg-get-val eg-filter-input eg-filter-selected<?php echo $f_id; ?>" type="checkbox" name="filter-selected<?php echo $f_id; ?>[]" data-origname="filter-selected-#NR[]" checked="checked" value="<?php echo esc_attr($fs); ?>" />                              
									</div>
								<?php } ?>
								</div>
							</div>
		...
		<div>
			...
			<div class="eg-cs-tbc">
				...
				--><input type="text" name="sort-by-text" class="esg-w-305" value="<?php echo esc_attr($base->getVar($grid, ['params', 'sort-by-text'], esc_attr__('Sort By ', ESG_TEXTDOMAIN))); ?>" >
				<div class="div13"></div>
				...
				if (!empty($all_metas)) {
					...
					foreach ($all_metas as $c_meta) {
						...
						?>
						<option value="<?php echo $type . esc_attr($c_meta['handle']); ?>"<?php selected(in_array($type.$c_meta['handle'], $order_by), true); ?>><?php echo esc_html($c_meta['name']);
				...
				--><?php $order_by_start = $base->getVar($grid, ['params', 'sorting-order-by-start'], 'none'); ?><select class="esg-w-305" name="sorting-order-by-start" >
					...
					if (!empty($all_metas)) {
						...
						foreach ($all_metas as $c_meta) {
							$type = ($c_meta['m_type'] == 'link') ? 'egl-' : 'eg-';
							?>
							<option value="<?php echo $type . esc_attr($c_meta['handle']); ?>"<?php selected($type.$c_meta['handle'] == $order_by_start, true); ?>><?php echo esc_html($c_meta['name']);
							echo ($c_meta['m_type'] == 'link') ? ' (' .esc_attr__('Link', ESG_TEXTDOMAIN).')' : ''; ?></option>
							<?php
						}
					}
		...
		<div class=" search_settings">
			...
			--><input type="text" class="esg-w-305" name="search-text" value="<?php echo esc_attr($base->getVar($grid, ['params', 'search-text'], esc_attr__('Search...', ESG_TEXTDOMAIN))); ?>" >
			</div>
		</div>
		...
		<div>
			...
			<div class="eg-cs-tbc">
				...
				<div class="lightbox-mode-addition-wrapper<?php echo ($lighbox_mode == 'content' || $lighbox_mode == 'content-gallery' || $lighbox_mode == 'woocommerce-gallery') ? '' : ' esg-display-none'; ?>">
					...
					--><input type="radio" name="lightbox-exclude-media" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-exclude-media'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Exclude original media from Source Order', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
					--><input type="radio" name="lightbox-exclude-media" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-exclude-media'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Include original media from Source Order', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
				</div>
				<div class="div13"></div>
				<label><?php esc_html_e('Group Name', ESG_TEXTDOMAIN); ?></label><?php $lightbox_deep_link = $base->getVar($grid, ['params', 'lightbox-deep-link'], 'group'); ?><input type="text" name="lightbox-deep-link" class="esg-w-305" value="<?php echo esc_attr($lightbox_deep_link); ?>" />
				<div class="div13"></div>
				...
				--><input type="radio" name="lightbox-videoautoplay" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-videoautoplay'], 'on'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Play videos automatically', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="lightbox-videoautoplay" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-videoautoplay'], 'on'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Do not play videos automatically', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
			</div>
				...
				<div>
					...
					<div class="eg-cs-tbc esg-ui-colors-option-wrapper">
						...
						<div class="esg-lightbox-override-ui-colors">
							...
							--><input type="radio" name="lightbox-override-ui-colors" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-override-ui-colors'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Use Default', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Use Default', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
							--><input type="radio" name="lightbox-override-ui-colors" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-override-ui-colors'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Override', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Override', ESG_TEXTDOMAIN); ?></span>
							<div class="div13"></div>
						</div>
				...
				<div>
					...
					<div class="eg-cs-tbc">
						<label class="eg-tooltip-wrap" title="<?php esc_attr_e('Strip tags in title / description', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Strip Tags', ESG_TEXTDOMAIN); ?></label><!--
								--><input type="radio" name="lightbox-title-strip" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-title-strip'], 'on'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Display above the image', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
							--><input type="radio" name="lightbox-title-strip" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-title-strip'], 'on'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Display under the image', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
						<div class="div13"></div>
						...
						<label class="eg-tooltip-wrap" title="<?php esc_attr_e('Show title / description above or under the image in lightbox', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Position', ESG_TEXTDOMAIN); ?></label><!--
							--><input type="radio" name="lightbox-title-position" value="top" <?php checked($base->getVar($grid, ['params', 'lightbox-title-position'], 'bottom'), 'top'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Display above the image', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Top', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
							--><input type="radio" name="lightbox-title-position" value="bottom" <?php checked($base->getVar($grid, ['params', 'lightbox-title-position'], 'bottom'), 'bottom'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Display under the image', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Bottom', ESG_TEXTDOMAIN); ?></span>
						<div class="div13"></div>
						...
						<div class="esg-lightbox-title">
							...
							--><input type="radio" name="lightbox-title" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-title'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Display Item Title', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
							--><input type="radio" name="lightbox-title" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-title'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Do not display Item Title', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>              
							<div class="div13"></div>
						</div>
						...
						<div class="esg-lightbox-description">
							...
							--><input type="radio" name="lightbox-description" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-description'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Display Item Title', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
							--><input type="radio" name="lightbox-description" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-description'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Do not display Item Title', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>              
							<div class="div13"></div>
						</div>
						...
						--><span class="esg-display-inline-block"><input class="input-settings-small eg-tooltip-wrap" title="<?php esc_attr_e('Padding Top of the LightBox', ESG_TEXTDOMAIN); ?>" type="text" name="lbox-padding[]" value="<?php echo esc_attr($base->getVar($lbox_padding, 0)); ?>" /> px</span><div class="space18"></div><!--
						--><span class="esg-display-inline-block"><input class="input-settings-small eg-tooltip-wrap" title="<?php esc_attr_e('Padding Right of the LightBox', ESG_TEXTDOMAIN); ?>" type="text" name="lbox-padding[]" value="<?php echo esc_attr($base->getVar($lbox_padding, 1)); ?>" /> px</span><div class="space18"></div><!--
						--><span class="esg-display-inline-block"><input class="input-settings-small eg-tooltip-wrap" title="<?php esc_attr_e('Padding Bottom of the LightBox', ESG_TEXTDOMAIN); ?>" type="text" name="lbox-padding[]" value="<?php echo esc_attr($base->getVar($lbox_padding, 2)); ?>" /> px</span><div class="space18"></div><!--
						--><span class="esg-display-inline-block"><input class="input-settings-small eg-tooltip-wrap" title="<?php esc_attr_e('Padding Left of the LightBox', ESG_TEXTDOMAIN); ?>" type="text" name="lbox-padding[]" value="<?php echo esc_attr($base->getVar($lbox_padding, 3)); ?>" /> px</span>
					</div>
				</div>
				<div>
					...
					<div class="eg-cs-tbc">
						...
						--><select name="lightbox-effect-open-close" class="esg-lighbox-effect-select">
							<option value="false"<?php selected($base->getVar($grid, ['params', 'lightbox-effect-open-close'], 'fade'), 'false'); ?>><?php esc_html_e('None', ESG_TEXTDOMAIN); ?></option>
							<option value="fade"<?php selected($base->getVar($grid, ['params', 'lightbox-effect-open-close'], 'fade'), 'fade'); ?>><?php esc_html_e('Fade', ESG_TEXTDOMAIN); ?></option>
							<option value="zoom-in-out"<?php selected($base->getVar($grid, ['params', 'lightbox-effect-open-close'], 'fade'), 'zoom-in-out'); ?>><?php esc_html_e('Zoom In Out', ESG_TEXTDOMAIN); ?></option>
						</select><!--
						--><?php
						...
						?><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Animation Speed', ESG_TEXTDOMAIN); ?>">Speed</span><div class="space18"></div><input class="input-settings-small" type="text" name="lightbox-effect-open-close-speed" value="<?php echo esc_attr($lightbox_effect_open_close_speed); ?>" /> ms
						<div class="div13"></div>
						...
						--><select name="lightbox-effect-next-prev" class="esg-lighbox-effect-select">
							<option value="none"<?php selected($base->getVar($grid, ['params', 'lightbox-effect-next-prev'], 'fade'), 'false'); ?>><?php esc_html_e('None', ESG_TEXTDOMAIN); ?></option>
							<option value="fade"<?php selected($base->getVar($grid, ['params', 'lightbox-effect-next-prev'], 'fade'), 'fade'); ?>><?php esc_html_e('Fade', ESG_TEXTDOMAIN); ?></option>
							<option value="slide"<?php selected($base->getVar($grid, ['params', 'lightbox-effect-next-prev'], 'fade'), 'slide'); ?>><?php esc_html_e('Slide', ESG_TEXTDOMAIN); ?></option>
							<option value="circular"<?php selected($base->getVar($grid, ['params', 'lightbox-effect-next-prev'], 'fade'), 'circular'); ?>><?php esc_html_e('Circular', ESG_TEXTDOMAIN); ?></option>
							<option value="tube"<?php selected($base->getVar($grid, ['params', 'lightbox-effect-next-prev'], 'fade'), 'tube'); ?>><?php esc_html_e('Tube', ESG_TEXTDOMAIN); ?></option>
							<option value="zoom-in-out"<?php selected($base->getVar($grid, ['params', 'lightbox-effect-next-prev'], 'fade'), 'zoom-in-out'); ?>><?php esc_html_e('Zoom In Out', ESG_TEXTDOMAIN); ?></option>
							<option value="rotate"<?php selected($base->getVar($grid, ['params', 'lightbox-effect-next-prev'], 'fade'), 'rotate'); ?>><?php esc_html_e('Rotate', ESG_TEXTDOMAIN); ?></option>
						</select><!--
						--><?php
						...
						?><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Transition Speed', ESG_TEXTDOMAIN); ?>">Speed</span><div class="space18"></div><input class="input-settings-small" type="text" name="lightbox-effect-next-prev-speed" value="<?php echo esc_attr($lightbox_effect_next_prev_speed); ?>" /> ms             
					</div>
				</div>
			</div>
			<div>
				...
				<div class="eg-cs-tbc">
					...
					--><input type="radio" name="lightbox-autoplay" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-autoplay'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('AutoPlay Elements in Lightbox.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
					--><input type="radio" name="lightbox-autoplay" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-autoplay'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Dont AutoPlay Elements in LightBox.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
					<div class="div13"></div>
			...
			<div>
				...
				--><span class="esg-display-inline-block"><input type="radio" name="lightbox-arrows" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-arrows'], 'on'), 'on'); ?>><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><span><input type="radio" name="lightbox-arrows" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-arrows'], 'on'), 'off'); ?>><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
				<div class="div13"></div>
				<label><?php esc_html_e('Loop Items', ESG_TEXTDOMAIN); ?></label><!--
				--><input type="radio" name="lightbox-loop" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-loop'], 'on'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Loop items after last is shown.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="lightbox-loop" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-loop'], 'on'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Do not loop items.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
				<div class="div13"></div>
				<label><?php esc_html_e('Item Numbers', ESG_TEXTDOMAIN); ?></label><!--
				--><input type="radio" name="lightbox-numbers" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-numbers'], 'on'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Show numbers such as 1-8, etc.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="lightbox-numbers" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-numbers'], 'on'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Do not display numbers', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
				<div class="div13"></div>
				<label><?php esc_html_e('Mouse Wheel', ESG_TEXTDOMAIN); ?></label><!--
				--><input type="radio" name="lightbox-mousewheel" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-mousewheel'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Enable mouse wheel to change items when lightbox is open', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="lightbox-mousewheel" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-mousewheel'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Do not use mouse wheel', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>           
				</div>
			</div>
			...
			<div id="eg-post-content-options">
			  <!-- 2.1.6 -->
				...
				<div class="eg-cs-tbc">
					...
					<input type="radio" name="lightbox-post-content-min-perc" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-post-content-min-perc'], 'on'), 'on'); ?>> <?php esc_html_e('%', ESG_TEXTDOMAIN); ?><div class="space18"></div>
					<input type="radio" name="lightbox-post-content-min-perc" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-post-content-min-perc'], 'on'), 'off'); ?>> <?php esc_html_e('px', ESG_TEXTDOMAIN); ?>
					<div class="div13"></div>
					...
					<input type="radio" name="lightbox-post-content-max-perc" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-post-content-max-perc'], 'on'), 'on'); ?>> <?php esc_html_e('%', ESG_TEXTDOMAIN); ?><div class="space18"></div>
					<input type="radio" name="lightbox-post-content-max-perc" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-post-content-max-perc'], 'on'), 'off'); ?>> <?php esc_html_e('px', ESG_TEXTDOMAIN); ?>
					<div class="div13"></div>
					...
					<input type="radio" name="lightbox-post-content-overflow" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-post-content-overflow'], 'on'), 'on'); ?>> <?php esc_html_e('On', ESG_TEXTDOMAIN); ?><div class="space18"></div>
					<input type="radio" name="lightbox-post-content-overflow" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-post-content-overflow'], 'on'), 'off'); ?>> <?php esc_html_e('Off', ESG_TEXTDOMAIN); ?>
					<div class="div13"></div>
					<?php
					...
					<span class="eg-tooltip-wrap" title="<?php esc_attr_e('Padding Top (px)', ESG_TEXTDOMAIN); ?>">Top</span> <input class="input-settings-small esg-margin-r-10" type="text" name="lbox-content_padding[]" value="<?php echo esc_attr($base->getVar($lbox_post_img_padding, 0)); ?>" />
					<span class="eg-tooltip-wrap" title="<?php esc_attr_e('Padding Right (px)', ESG_TEXTDOMAIN); ?>">Right</span> <input class="input-settings-small esg-margin-r-10" type="text" name="lbox-content_padding[]" value="<?php echo esc_attr($base->getVar($lbox_post_img_padding, 1)); ?>" />
					<span class="eg-tooltip-wrap" title="<?php esc_attr_e('Padding Bottom (px)', ESG_TEXTDOMAIN); ?>">Bottom</span> <input class="input-settings-small esg-margin-r-10" type="text" name="lbox-content_padding[]" value="<?php echo esc_attr($base->getVar($lbox_post_img_padding, 2)); ?>" />
					<span class="eg-tooltip-wrap" title="<?php esc_attr_e('Padding Left (px)', ESG_TEXTDOMAIN); ?>">Left</span> <input class="input-settings-small esg-margin-r-10" type="text" name="lbox-content_padding[]" value="<?php echo esc_attr($base->getVar($lbox_post_img_padding, 3)); ?>" />
					<div class="div13"></div>
					...
					<input type="radio" name="lightbox-post-spinner" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-post-spinner'], 'off'), 'on'); ?>> <?php esc_html_e('On', ESG_TEXTDOMAIN); ?><div class="space18"></div>
					<input type="radio" name="lightbox-post-spinner" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-post-spinner'], 'off'), 'off'); ?>> <?php esc_html_e('Off', ESG_TEXTDOMAIN); ?>
					<div class="div13"></div>
					...
					<input type="radio" class="lightbox-post-content-img " name="lightbox-post-content-img" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-post-content-img'], 'off'), 'on'); ?>> <?php esc_html_e('On', ESG_TEXTDOMAIN); ?><div class="space18"></div>
					<input type="radio" class="lightbox-post-content-img" name="lightbox-post-content-img" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-post-content-img'], 'off'), 'off'); ?>> <?php esc_html_e('Off', ESG_TEXTDOMAIN); ?>
					<div class="featured-img-hideable">
						...
						<select id="lightbox-post-content-img-position" name="lightbox-post-content-img-position">
							<option value="top"<?php selected($base->getVar($grid, ['params', 'lightbox-post-content-img-position'], 'top'), 'top'); ?>><?php esc_html_e('Top', ESG_TEXTDOMAIN); ?></option>
							<option value="right"<?php selected($base->getVar($grid, ['params', 'lightbox-post-content-img-position'], 'top'), 'right'); ?>><?php esc_html_e('Right', ESG_TEXTDOMAIN); ?></option>
							<option value="bottom"<?php selected($base->getVar($grid, ['params', 'lightbox-post-content-img-position'], 'top'), 'bottom'); ?>><?php esc_html_e('Bottom', ESG_TEXTDOMAIN); ?></option>
							<option value="left"<?php selected($base->getVar($grid, ['params', 'lightbox-post-content-img-position'], 'top'), 'left'); ?>><?php esc_html_e('Left', ESG_TEXTDOMAIN); ?></option>
						</select>
					</div>
					<?php
					...
					<div class="featured-img-hideable">
						...
						<span class="eg-tooltip-wrap" title="<?php esc_attr_e('Margin Top of the Featured Image (px)', ESG_TEXTDOMAIN); ?>">Top</span> <input class="input-settings-small esg-margin-r-10" type="text" name="lightbox-post-content-img-margin[]" value="<?php echo esc_attr($base->getVar($lbox_post_img_margin, 0)); ?>" />
						<span class="eg-tooltip-wrap" title="<?php esc_attr_e('Margin Right of the Featured Image (px)', ESG_TEXTDOMAIN); ?>">Right</span> <input class="input-settings-small esg-margin-r-10" type="text" name="lightbox-post-content-img-margin[]" value="<?php echo esc_attr($base->getVar($lbox_post_img_margin, 1)); ?>" />
						<span class="eg-tooltip-wrap" title="<?php esc_attr_e('Margin Bottom of the Featured Image (px)', ESG_TEXTDOMAIN); ?>">Bottom</span> <input class="input-settings-small esg-margin-r-10" type="text" name="lightbox-post-content-img-margin[]" value="<?php echo esc_attr($base->getVar($lbox_post_img_margin, 2)); ?>" />
						<span class="eg-tooltip-wrap" title="<?php esc_attr_e('Margin Left of the Featured Image (px)', ESG_TEXTDOMAIN); ?>">Left</span> <input class="input-settings-small esg-margin-r-10" type="text" name="lightbox-post-content-img-margin[]" value="<?php echo esc_attr($base->getVar($lbox_post_img_margin, 3)); ?>" />
					</div>
					<div class="div13"></div>
					...
					<input type="radio" name="lightbox-post-content-title" value="on" <?php checked($base->getVar($grid, ['params', 'lightbox-post-content-title'], 'off'), 'on'); ?>> <?php esc_html_e('On', ESG_TEXTDOMAIN); ?><div class="space18"></div>
					<input type="radio" name="lightbox-post-content-title" value="off" <?php checked($base->getVar($grid, ['params', 'lightbox-post-content-title'], 'off'), 'off'); ?>> <?php esc_html_e('Off', ESG_TEXTDOMAIN); ?>
					<div class="div13"></div>
					...
					<select name="lightbox-post-content-title-tag">
						<option value="h1"<?php selected($base->getVar($grid, ['params', 'lightbox-post-content-title-tag'], 'h2'), 'h1'); ?>><?php esc_html_e('h1', ESG_TEXTDOMAIN); ?></option>
						<option value="h2"<?php selected($base->getVar($grid, ['params', 'lightbox-post-content-title-tag'], 'h2'), 'h2'); ?>><?php esc_html_e('h2', ESG_TEXTDOMAIN); ?></option>
						<option value="h3"<?php selected($base->getVar($grid, ['params', 'lightbox-post-content-title-tag'], 'h2'), 'h3'); ?>><?php esc_html_e('h3', ESG_TEXTDOMAIN); ?></option>
						<option value="h4"<?php selected($base->getVar($grid, ['params', 'lightbox-post-content-title-tag'], 'h2'), 'h4'); ?>><?php esc_html_e('h4', ESG_TEXTDOMAIN); ?></option>
						<option value="p"<?php selected($base->getVar($grid, ['params', 'lightbox-post-content-title-tag'], 'h2'), 'p'); ?>><?php esc_html_e('p', ESG_TEXTDOMAIN); ?></option>
					</select>
		...
		<div>
			...
			<div>
				...
				<div class="eg-cs-tbc">
					...
					--><input type="radio" name="ajax-container-position" value="top" <?php checked($base->getVar($grid, ['params', 'ajax-container-position'], 'top'), 'top'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Visible above the Grid', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Top', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
					--><input type="radio" name="ajax-container-position" value="bottom" <?php checked($base->getVar($grid, ['params', 'ajax-container-position'], 'top'), 'bottom'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Visible under the Grid', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Bottom', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
					--><input type="radio" name="ajax-container-position" value="shortcode" <?php checked($base->getVar($grid, ['params', 'ajax-container-position'], 'top'), 'shortcode'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Insert somewhere as ShortCode', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('As ShortCode', ESG_TEXTDOMAIN); ?></span>           
					...
					--><input type="radio" name="ajax-scroll-onload" value="on" <?php checked($base->getVar($grid, ['params', 'ajax-scroll-onload'], 'on'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Scroll to content.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
					--><input type="radio" name="ajax-scroll-onload" value="off" <?php checked($base->getVar($grid, ['params', 'ajax-scroll-onload'], 'on'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Do not scroll to content.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
					<div class="div13"></div>
			...
			<div>
				...
				<div class="eg-cs-tbc">
					...
					--><span class="esg-display-inline-block"><input type="radio" name="ajax-close-button" value="on" class=" eg-tooltip-wrap" <?php checked($base->getVar($grid, ['params', 'ajax-close-button'], 'off'), 'on'); ?>><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
					--><span class="esg-display-inline-block"><input type="radio" name="ajax-close-button" value="off" class="eg-tooltip-wrap" <?php checked($base->getVar($grid, ['params', 'ajax-close-button'], 'off'), 'off'); ?>><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
					...
					<div class="eg-close-button-settings-wrap">
						<div class="eg-button-text-wrap">
							...
							--><input type="text" name="ajax-button-text" value="<?php echo esc_attr($base->getVar($grid, ['params', 'ajax-button-text'], esc_attr__('Close', ESG_TEXTDOMAIN))); ?>">
						</div>
					</div>
					...
					--><span class="esg-display-inline-block"><input type="radio" name="ajax-nav-button" value="on" class=" eg-tooltip-wrap" <?php checked($base->getVar($grid, ['params', 'ajax-nav-button'], 'off'), 'on'); ?>><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
					--><span class="esg-display-inline-block"><input type="radio" name="ajax-nav-button" value="off" <?php checked($base->getVar($grid, ['params', 'ajax-nav-button'], 'off'), 'off'); ?>><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
					...
					<div class="eg-close-nav-button-settings-wrap">
						...
						--><select name="ajax-button-skin" class="eg-tooltip-wrap" title="<?php esc_attr_e('Define the Skin of the buttons', ESG_TEXTDOMAIN); ?>">
							<option value="light"<?php selected($base->getVar($grid, ['params', 'ajax-button-skin'], 'light'), 'light'); ?>><?php esc_html_e('Light', ESG_TEXTDOMAIN); ?></option>
							<option value="dark"<?php selected($base->getVar($grid, ['params', 'ajax-button-skin'], 'light'), 'dark'); ?>><?php esc_html_e('Dark', ESG_TEXTDOMAIN); ?></option>
						</select>
						<div class="div13"></div>
						...
						--><input type="radio" name="ajax-button-type" value="type1" class=" eg-tooltip-wrap" <?php checked($base->getVar($grid, ['params', 'ajax-button-type'], 'type1'), 'type1'); ?>><?php esc_html_e('Type 1', ESG_TEXTDOMAIN); ?><div class="space18"></div><!--
						--><input type="radio" name="ajax-button-type" value="type2" <?php checked($base->getVar($grid, ['params', 'ajax-button-type'], 'type1'), 'type2'); ?>><?php esc_html_e('Type 2', ESG_TEXTDOMAIN); ?>
						<div class="div13"></div>
						...
						--><input type="radio" name="ajax-button-inner" value="true" class=" eg-tooltip-wrap" <?php checked($base->getVar($grid, ['params', 'ajax-button-inner'], 'false'), 'true'); ?>> <?php esc_html_e('Inner', ESG_TEXTDOMAIN); ?><div class="space18"></div><!--
						--><input type="radio" name="ajax-button-inner" value="false" <?php checked($base->getVar($grid, ['params', 'ajax-button-inner'], 'false'), 'false'); ?>><?php esc_html_e('Outer', ESG_TEXTDOMAIN); ?>
						<div class="div13"></div>
						...
						--><input type="radio" name="ajax-button-h-pos" value="l" <?php checked($base->getVar($grid, ['params', 'ajax-button-h-pos'], 'r'), 'l'); ?>><?php esc_html_e('Left', ESG_TEXTDOMAIN); ?><div class="space18"></div><!--
						--><input type="radio" name="ajax-button-h-pos" value="c" <?php checked($base->getVar($grid, ['params', 'ajax-button-h-pos'], 'r'), 'c'); ?>><?php esc_html_e('Center', ESG_TEXTDOMAIN); ?><div class="space18"></div><!--
						--><input type="radio" name="ajax-button-h-pos" value="r" <?php checked($base->getVar($grid, ['params', 'ajax-button-h-pos'], 'r'), 'r'); ?>><?php esc_html_e('Right', ESG_TEXTDOMAIN); ?>              
						<div class="div13"></div>
						...
						--><input type="radio" name="ajax-button-v-pos" value="t" <?php checked($base->getVar($grid, ['params', 'ajax-button-v-pos'], 't'), 't'); ?>><?php esc_html_e('Top', ESG_TEXTDOMAIN); ?><div class="space18"></div><!--
						--><input type="radio" name="ajax-button-v-pos" value="b" <?php checked($base->getVar($grid, ['params', 'ajax-button-v-pos'], 't'), 'b'); ?>><?php esc_html_e('Bottom', ESG_TEXTDOMAIN); ?>             
					</div>
				</div>
			</div>
	...
	<div id="esg-settings-api-settings" class="esg-settings-container">
		<div>
			...
			<div>
				...
				<div class="eg-cs-tbc">
				<?php if ($grid !== false) { ?>
					<label><?php esc_html_e('Redraw Grid:', ESG_TEXTDOMAIN); ?></label><input class="eg-api-inputs" type="text" name="do-not-save" value="essapi_<?php echo esc_attr($grid['id']); ?>.esredraw();" readonly="true" />
					<div class="div13"></div>
					<label><?php esc_html_e('Quick Redraw Grid:', ESG_TEXTDOMAIN); ?></label><input class="eg-api-inputs" type="text" name="do-not-save" value="essapi_<?php echo esc_attr($grid['id']); ?>.esquickdraw();" readonly="true" />
				<?php } else { ?>
					<p>
	...
	<div id="esg-settings-cookie-settings" class="esg-settings-container">
		<div>
			<div>
				...
				--><input type="text" name="cookie-save-time" class="input-settings-small " value="<?php echo intval($base->getVar($grid, ['params', 'cookie-save-time'], '30')); ?>"><div class="space18"></div><?php esc_html_e('Minutes', ESG_TEXTDOMAIN); ?>
				</div>
			</div>
			<div>
				...
				--><input type="radio" name="cookie-save-search" value="on" <?php checked($base->getVar($grid, ['params', 'cookie-save-search'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Remember user\'s last search.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="cookie-save-search" value="off" <?php checked($base->getVar($grid, ['params', 'cookie-save-search'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Do not apply cookie for search.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
				<div class="div13"></div>
				<label for="filter-arrows" ><?php esc_html_e('Filter', ESG_TEXTDOMAIN); ?></label><!--
				--><input type="radio" name="cookie-save-filter" value="on" <?php checked($base->getVar($grid, ['params', 'cookie-save-filter'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Remember Grid\'s last filter state.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="cookie-save-filter" value="off" <?php checked($base->getVar($grid, ['params', 'cookie-save-filter'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Do not apply cookie for filter.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
				<div class="div13"></div>
				<label for="filter-arrows" ><?php esc_html_e('Pagination', ESG_TEXTDOMAIN); ?></label><!--
				--><input type="radio" name="cookie-save-pagination" value="on" <?php checked($base->getVar($grid, ['params', 'cookie-save-pagination'], 'off'), 'on'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Remember Grid\'s last pagination state.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span><div class="space18"></div><!--
				--><input type="radio" name="cookie-save-pagination" value="off" <?php checked($base->getVar($grid, ['params', 'cookie-save-pagination'], 'off'), 'off'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Do not apply cookie for pagination.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span>
				<div class="div13"></div>
