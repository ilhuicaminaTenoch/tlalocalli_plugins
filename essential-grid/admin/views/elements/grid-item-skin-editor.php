...
global $esg_dev_mode;
if($esg_dev_mode) {
	wp_enqueue_script('esg-item-editor-script', plugins_url('../../assets/js/modules/dev/grid-editor.js', __FILE__ ), ['jquery'], ESG_REVISION );
} else {
	wp_enqueue_script('esg-item-editor-script', plugins_url('../../assets/js/modules/grid-editor.min.js', __FILE__ ), ['jquery'], ESG_REVISION );
}
...
<div id="skin-editor-wrapper">
	...
	<h2 class="topheader">
		<?php esc_html_e('Item Skin Editor', ESG_TEXTDOMAIN); ?>
		...
		<div class="esg-item-skin-name">
			...
			<span class="esg-item-skin-name-notice">
				<?php esc_html_e('Class Prefix = ', ESG_TEXTDOMAIN); ?> .eg-<span class="eg-tooltip-wrap" title="<?php esc_attr_e('Each element in the Skin becomes this CSS Prefix', ESG_TEXTDOMAIN); ?>" id="eg-item-skin-slug"></span>-
			</span>
		</div>
	</h2>
					...
					<div class="esg-box-inside">
						...
						<div class="eg-lc-menu-wrapper">
							...
							<div id="eg-lc-layout" class="esg-lc-settings-container active-esc">
								...
								--><span class="esg-display-inline-block"><input type="radio" name="choose-layout" value="even"  <?php checked($base->getVar($skin, ['params', 'choose-layout'], 'even'), 'even'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Each item gets Same Height. Width and Height are Item Ratio dependent.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Even', ESG_TEXTDOMAIN); ?></span></span><div class="space18"></div><!--
								--><span><input type="radio" name="choose-layout" value="masonry" <?php checked($base->getVar($skin, ['params', 'choose-layout'], 'even'), 'masonry'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Items height are depending on Media height and Content height.', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Masonry', ESG_TEXTDOMAIN); ?></span></span>
								<!-- MASONRY SETTINGS-->
								<div id="eg-show-content">
									...
									--><select name="show-content">
										<option value="bottom" <?php selected($base->getVar($skin, ['params', 'show-content'], 'none'), 'bottom'); ?>><?php esc_html_e('Bottom', ESG_TEXTDOMAIN); ?></option>
										<option value="top" <?php selected($base->getVar($skin, ['params', 'show-content'], 'none'), 'top'); ?>><?php esc_html_e('Top', ESG_TEXTDOMAIN); ?></option>
										<option value="none" <?php selected($base->getVar($skin, ['params', 'show-content'], 'none'), 'none'); ?>><?php esc_html_e('Hide', ESG_TEXTDOMAIN); ?></option>
									</select><div class="space18"></div><!--
									--><select name="content-align">
										<option value="left" <?php selected($base->getVar($skin, ['params', 'content-align'], 'left'), 'left'); ?>><?php esc_html_e('Left', ESG_TEXTDOMAIN); ?></option>
										<option value="center" <?php selected($base->getVar($skin, ['params', 'content-align'], 'left'), 'center'); ?>><?php esc_html_e('Center', ESG_TEXTDOMAIN); ?></option>
										<option value="right" <?php selected($base->getVar($skin, ['params', 'content-align'], 'left'), 'right'); ?>><?php esc_html_e('Right', ESG_TEXTDOMAIN); ?></option>
									</select>
								</div>
								<div class="div13"></div>
								...
								--><select name="image-repeat">
										<option value="no-repeat" <?php selected($base->getVar($skin, ['params', 'image-repeat'], 'no-repeat'), 'no-repeat'); ?>><?php esc_html_e('no-repeat', ESG_TEXTDOMAIN); ?></option>
										<option value="repeat" <?php selected($base->getVar($skin, ['params', 'image-repeat'], 'no-repeat'), 'repeat'); ?>><?php esc_html_e('repeat', ESG_TEXTDOMAIN); ?></option>
										<option value="repeat-x" <?php selected($base->getVar($skin, ['params', 'image-repeat'], 'no-repeat'), 'repeat-x'); ?>><?php esc_html_e('repeat-x', ESG_TEXTDOMAIN); ?></option>
										<option value="repeat-y" <?php selected($base->getVar($skin, ['params', 'image-repeat'], 'no-repeat'), 'repeat-y'); ?>><?php esc_html_e('repeat-y', ESG_TEXTDOMAIN); ?></option>
								</select>
								<div class="div13"></div>
								...
								--><select name="image-fit">
									<option value="contain" <?php selected($base->getVar($skin, ['params', 'image-fit'], 'cover'), 'contain'); ?>><?php esc_html_e('Contain', ESG_TEXTDOMAIN); ?></option>
									<option value="cover" <?php selected($base->getVar($skin, ['params', 'image-fit'], 'cover'), 'cover'); ?>><?php esc_html_e('Cover', ESG_TEXTDOMAIN); ?></option>
								</select>
								<div class="div13"></div>
								...
								--><select name="image-align-horizontal">
									<option value="left" <?php selected($base->getVar($skin, ['params', 'image-align-horizontal'], 'center'), 'left'); ?>><?php esc_html_e('Hor. Left', ESG_TEXTDOMAIN); ?></option>
									<option value="center" <?php selected($base->getVar($skin, ['params', 'image-align-horizontal'], 'center'), 'center'); ?>><?php esc_html_e('Hor. Center', ESG_TEXTDOMAIN); ?></option>
									<option value="right" <?php selected($base->getVar($skin, ['params', 'image-align-horizontal'], 'center'), 'right'); ?>><?php esc_html_e('Hor. Right', ESG_TEXTDOMAIN); ?></option>
								</select><div class="space18"></div><!--
								--><select name="image-align-vertical">
									<option value="top" <?php selected($base->getVar($skin, ['params', 'image-align-vertical'], 'center'), 'top'); ?>><?php esc_html_e('Ver. Top', ESG_TEXTDOMAIN); ?></option>
									<option value="center" <?php selected($base->getVar($skin, ['params', 'image-align-vertical'], 'center'), 'center'); ?>><?php esc_html_e('Ver. Center', ESG_TEXTDOMAIN); ?></option>
									<option value="bottom" <?php selected($base->getVar($skin, ['params', 'image-align-vertical'], 'center'), 'bottom'); ?>><?php esc_html_e('Ver. Bottom', ESG_TEXTDOMAIN); ?></option>
								</select>
								<!-- EVEN SETTINGS -->
								...
								--><select name="splitted-item">
									<option value="none" <?php selected($base->getVar($skin, ['params', 'splitted-item'], 'none'), 'none'); ?>><?php esc_html_e('No Split', ESG_TEXTDOMAIN); ?></option>
									<option value="left" <?php selected($base->getVar($skin, ['params', 'splitted-item'], 'none'), 'left'); ?>><?php esc_html_e('Media Left', ESG_TEXTDOMAIN); ?></option>
									<option value="right" <?php selected($base->getVar($skin, ['params', 'splitted-item'], 'none'), 'right'); ?>><?php esc_html_e('Media Right', ESG_TEXTDOMAIN); ?></option>
								</select>
							</div>
							...
							<div id="eg-lc-cover" class="esg-lc-settings-container">
								...
								--><select id="cover-type" name="cover-type">
									<option value="full" <?php selected($base->getVar($skin, ['params', 'cover-type'], 'full'), 'full'); ?>><?php esc_html_e('Full', ESG_TEXTDOMAIN); ?></option>
									<option value="content" <?php selected($base->getVar($skin, ['params', 'cover-type'], 'full'), 'content'); ?>><?php esc_html_e('Content Based', ESG_TEXTDOMAIN); ?></option>
								</select>
								<div class="div13"></div>
								...
								--><select id="cover-blend-mode" name="cover-blend-mode">
									<option value="normal" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'normal'); ?>><?php esc_html_e('Normal', ESG_TEXTDOMAIN); ?></option>
									<option value="multiply" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'multiply'); ?>><?php esc_html_e('Multiply', ESG_TEXTDOMAIN); ?></option>
									<option value="screen" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'screen'); ?>><?php esc_html_e('Screen', ESG_TEXTDOMAIN); ?></option>
									<option value="overlay" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'overlay'); ?>><?php esc_html_e('Overlay', ESG_TEXTDOMAIN); ?></option>
									<option value="darken" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'darken'); ?>><?php esc_html_e('Darken', ESG_TEXTDOMAIN); ?></option>
									<option value="lighten" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'lighten'); ?>><?php esc_html_e('Lighten', ESG_TEXTDOMAIN); ?></option>
									<option value="color-dodge" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'color-dodge'); ?>><?php esc_html_e('Color Dodge', ESG_TEXTDOMAIN); ?></option>
									<option value="color-burn" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'color-burn'); ?>><?php esc_html_e('Color Burn', ESG_TEXTDOMAIN); ?></option>
									<option value="hard-light" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'hard-light'); ?>><?php esc_html_e('Hard Light', ESG_TEXTDOMAIN); ?></option>
									<option value="soft-light" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'soft-light'); ?>><?php esc_html_e('Soft Light', ESG_TEXTDOMAIN); ?></option>
									<option value="difference" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'difference'); ?>><?php esc_html_e('Difference', ESG_TEXTDOMAIN); ?></option>
									<option value="exclusion" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'exclusion'); ?>><?php esc_html_e('Exclusion', ESG_TEXTDOMAIN); ?></option>
									<option value="hue" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'hue'); ?>><?php esc_html_e('Hue', ESG_TEXTDOMAIN); ?></option>
									<option value="saturation" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'saturation'); ?>><?php esc_html_e('Saturation', ESG_TEXTDOMAIN); ?></option>
									<option value="color" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'color'); ?>><?php esc_html_e('Color', ESG_TEXTDOMAIN); ?></option>
									<option value="luminosity" <?php selected($base->getVar($skin, ['params', 'cover-blend-mode'], 'normal'), 'luminosity'); ?>><?php esc_html_e('Luminosity', ESG_TEXTDOMAIN); ?></option>
								</select>
								<div class="div13"></div>
								...
								<div class="esg-display-none">
									...
									--><select name="cover-background-size">
										<option value="cover" <?php selected($base->getVar($skin, ['params', 'cover-background-size'], 'cover'), 'cover'); ?>><?php esc_html_e('Cover', ESG_TEXTDOMAIN); ?></option>
										<option value="contain" <?php selected($base->getVar($skin, ['params', 'cover-background-size'], 'cover'), 'contain'); ?>><?php esc_html_e('Contain', ESG_TEXTDOMAIN); ?></option>
										<option value="auto" <?php selected($base->getVar($skin, ['params', 'cover-background-size'], 'cover'), 'auto'); ?>><?php esc_html_e('Normal', ESG_TEXTDOMAIN); ?></option>
									</select>
								</div>
								<div class="esg-display-none">
									<label class="eg-group-setter"><?php esc_html_e('Background Repeat', ESG_TEXTDOMAIN); ?></label><!--
									--><select name="cover-background-repeat">
										<option value="no-repeat" <?php selected($base->getVar($skin, ['params', 'cover-background-repeat'], 'no-repeat'), 'auto'); ?>><?php esc_html_e('no-repeat', ESG_TEXTDOMAIN); ?></option>
										<option value="repeat" <?php selected($base->getVar($skin, ['params', 'cover-background-repeat'], 'no-repeat'), 'repeat'); ?>><?php esc_html_e('repeat', ESG_TEXTDOMAIN); ?></option>
										<option value="repeat-x" <?php selected($base->getVar($skin, ['params', 'cover-background-repeat'], 'no-repeat'), 'repeat-x'); ?>><?php esc_html_e('repeat-x', ESG_TEXTDOMAIN); ?></option>
										<option value="repeat-y" <?php selected($base->getVar($skin, ['params', 'cover-background-repeat'], 'no-repeat'), 'repeat-y'); ?>><?php esc_html_e('repeat-y', ESG_TEXTDOMAIN); ?></option>
									</select>
								</div>
								<div class="esg-display-none">
									<?php
									...
									--><div id="cover-background-image-wrap"<?php echo ($cover_image_url !== false) ? ' style="background-image: url('.esc_attr($cover_image_url[0]).'); background-size: 100% 100%;"' : ''; ?>><?php esc_html_e("Click to<br>Select<br>Image", ESG_TEXTDOMAIN); ?></div><!--
							...
							<div id="eg-lc-spaces" class="esg-lc-settings-container">
								...
								<div id="eg-style-full">
									...
									--><select name="full-border-style">
										<option value="none" <?php selected($base->getVar($skin, ['params', 'full-border-style'], 'none'), 'none'); ?>><?php esc_html_e('none', ESG_TEXTDOMAIN); ?></option>
										<option value="solid" <?php selected($base->getVar($skin, ['params', 'full-border-style'], 'none'), 'solid'); ?>><?php esc_html_e('solid', ESG_TEXTDOMAIN); ?></option>
										<option value="dotted" <?php selected($base->getVar($skin, ['params', 'full-border-style'], 'none'), 'dotted'); ?>><?php esc_html_e('dotted', ESG_TEXTDOMAIN); ?></option>
										<option value="dashed" <?php selected($base->getVar($skin, ['params', 'full-border-style'], 'none'), 'dashed'); ?>><?php esc_html_e('dashed', ESG_TEXTDOMAIN); ?></option>
										<option value="double" <?php selected($base->getVar($skin, ['params', 'full-border-style'], 'none'), 'double'); ?>><?php esc_html_e('double', ESG_TEXTDOMAIN); ?></option>
									</select>
									<div class="div13"></div>
									<label><?php esc_html_e('Overflow Hidden', ESG_TEXTDOMAIN); ?></label><!--
									--><span class="esg-display-inline-block"><input type="radio" name="full-overflow-hidden" value="true"  <?php checked($base->getVar($skin, ['params', 'full-overflow-hidden'], 'false'), 'true'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Hide Overflow (fix border radius issues)', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('On', ESG_TEXTDOMAIN); ?></span></span><div class="space18"></div><!--
									--><span><input type="radio" name="full-overflow-hidden" value="false" <?php checked($base->getVar($skin, ['params', 'full-overflow-hidden'], 'false'), 'false'); ?>><span class="eg-tooltip-wrap" title="<?php esc_attr_e('Show Overflowed content', ESG_TEXTDOMAIN); ?>"><?php esc_html_e('Off', ESG_TEXTDOMAIN); ?></span></span>
								</div>
								<div id="eg-style-content" class="esg-display-none">
									...
									--><select name="content-border-style">
										<option value="none" <?php selected($base->getVar($skin, ['params', 'content-border-style'], 'none'), 'none'); ?>><?php esc_html_e('none', ESG_TEXTDOMAIN); ?></option>
										<option value="solid" <?php selected($base->getVar($skin, ['params', 'content-border-style'], 'none'), 'solid'); ?>><?php esc_html_e('solid', ESG_TEXTDOMAIN); ?></option>
										<option value="dotted" <?php selected($base->getVar($skin, ['params', 'content-border-style'], 'none'), 'dotted'); ?>><?php esc_html_e('dotted', ESG_TEXTDOMAIN); ?></option>
										<option value="dashed" <?php selected($base->getVar($skin, ['params', 'content-border-style'], 'none'), 'dashed'); ?>><?php esc_html_e('dashed', ESG_TEXTDOMAIN); ?></option>
										<option value="double" <?php selected($base->getVar($skin, ['params', 'content-border-style'], 'none'), 'double'); ?>><?php esc_html_e('double', ESG_TEXTDOMAIN); ?></option>
									</select>
								</div>
							</div>
							...
							<div id="eg-lc-content-animation" class="esg-lc-settings-container ">
								...
								<div id="eg-cover-animation-top">
									...
									--><select name="cover-animation-top-type" class="esg-w-60" title="<?php esc_attr_e('Show or Hide on hover. In = Show on Hover, Out = Hide on hover', ESG_TEXTDOMAIN); ?>">
										<option value="" <?php selected($base->getVar($skin, ['params', 'cover-animation-top-type']), ''); ?>><?php esc_html_e('in', ESG_TEXTDOMAIN); ?></option>
										<option value="out" <?php selected($base->getVar($skin, ['params', 'cover-animation-top-type']), 'out'); ?>><?php esc_html_e('out', ESG_TEXTDOMAIN); ?></option>
									</select><div class="space5"></div><!--
									--><input class="input-settings-small element-setting eg-tooltip-wrap input-animation-delay" title="<?php esc_attr_e('Delay before the Animation starts', ESG_TEXTDOMAIN); ?>" type="text" name="cover-animation-delay-top" value="<?php echo esc_attr($base->getVar($skin, ['params', 'cover-animation-delay-top'], '0', 'i')); ?>" /><div class="space5"></div><!--
								...
								<div id="eg-cover-animation-center">
									...
									--><select name="cover-animation-center-type" class="eg-tooltip-wrap esg-w-60" title="<?php esc_attr_e('Show or Hide on hover. In = Show on Hover, Out = Hide on hover', ESG_TEXTDOMAIN); ?>">
										<option value="" <?php selected($base->getVar($skin, ['params', 'cover-animation-center-type']), ''); ?>><?php esc_html_e('in', ESG_TEXTDOMAIN); ?></option>
										<option value="out" <?php selected($base->getVar($skin, ['params', 'cover-animation-center-type']), 'out'); ?>><?php esc_html_e('out', ESG_TEXTDOMAIN); ?></option>
									</select><div class="space5"></div><!--
									--><input class="input-settings-small element-setting eg-tooltip-wrap input-animation-delay" title="<?php esc_attr_e('Delay before the Animation starts', ESG_TEXTDOMAIN); ?>" type="text" name="cover-animation-delay-center" value="<?php echo esc_attr($base->getVar($skin, ['params', 'cover-animation-delay-center'], '0', 'i')); ?>" /><div class="space5"></div><!--
								...
								<div id="eg-cover-animation-bottom">
									...
									--><select name="cover-animation-bottom-type" class="eg-tooltip-wrap esg-w-60" title="<?php esc_attr_e('Show or Hide on hover. In = Show on Hover, Out = Hide on hover', ESG_TEXTDOMAIN); ?>">
										<option value="" <?php selected($base->getVar($skin, ['params', 'cover-animation-bottom-type']), ''); ?>><?php esc_html_e('in', ESG_TEXTDOMAIN); ?></option>
										<option value="out" <?php selected($base->getVar($skin, ['params', 'cover-animation-bottom-type']), 'out'); ?>><?php esc_html_e('out', ESG_TEXTDOMAIN); ?></option>
									</select><div class="space5"></div><!--
								...
								--><input class="input-settings-small element-setting eg-tooltip-wrap input-animation-delay" type="text" name="cover-group-animation-delay" title="<?php esc_attr_e('Delay before the Animation starts', ESG_TEXTDOMAIN); ?>" value="<?php echo esc_attr($base->getVar($skin, ['params', 'cover-group-animation-delay'], '0', 'i')); ?>" />
								<div class="div13"></div>
								...
								--><input class="input-settings-small element-setting eg-tooltip-wrap input-animation-delay" type="text" name="media-animation-delay" title="<?php esc_attr_e('Delay before the Animation starts', ESG_TEXTDOMAIN); ?>" value="<?php echo esc_attr($base->getVar($skin, ['params', 'media-animation-delay'], '0', 'i')); ?>" /><div class="space5"></div><!--
							...
							<div id="eg-lc-content-link-seo" class="esg-lc-settings-container">
									...
									<div class="add-link-to-wrapper" class="esg-display-none">
										...
										<div id="eg-link-post-url-wrap" class="esg-display-none">
											<div class="div13"></div>
											<label><?php esc_html_e('Link To URL', ESG_TEXTDOMAIN); ?></label><input class="element-setting" type="text" name="link-url-link" value="<?php echo esc_attr($base->getVar($skin, ['params', 'link-url-link'])); ?>" />
										</div>
										<div id="eg-link-post-meta-wrap" class="esg-display-none">
											<div class="div13"></div>
											<label><?php esc_html_e('Meta Key', ESG_TEXTDOMAIN); ?></label><input class="element-setting" type="text" name="link-meta-link" value="<?php echo esc_attr($base->getVar($skin, ['params', 'link-meta-link'])); ?>" readonly /><div class="space18"></div><!--
										...
										<div id="eg-link-post-javascript-wrap" class="esg-display-none">
											<div class="div13"></div>
											<label><?php esc_html_e('Link JavaScript', ESG_TEXTDOMAIN); ?></label><input class="element-setting" type="text" name="link-javascript-link" value="<?php echo esc_attr($base->getVar($skin, ['params', 'link-javascript-link'])); ?>" />
										</div>
