	...
	if(is_array($sidebars) && !empty($sidebars)){
		foreach($sidebars as $handle => $name){
			...
			<div class="eg-pbox esg-box esg-box-grid-widget-area">
				<h3 class="box-closed"><span class="esg-font-w-400"><?php esc_html_e('Handle:', ESG_TEXTDOMAIN); ?></span><span>eg-<?php echo esc_html($handle); ?> </span><span class="eg-pbox-arrow"></span></h3>
				<div class="esg-box-inside">
					...
					<div class="eg-custommeta-row">
						<div class="eg-cus-row-l"><label for="esg-widget-area-name"><?php esc_html_e('Name:', ESG_TEXTDOMAIN); ?></label><input type="text" id="esg-widget-area-name" name="esg-widget-area-name[]" value="<?php echo esc_attr($name); ?>"></div>
					</div>
