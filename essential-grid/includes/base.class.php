...
class Essential_Grid_Base
{
	...
	{
		$media = ['featured-image' => ['name' => esc_attr__('Featured Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'youtube' => ['name' => esc_attr__('YouTube Video', ESG_TEXTDOMAIN), 'type' => 'video'],
			'vimeo' => ['name' => esc_attr__('Vimeo Video', ESG_TEXTDOMAIN), 'type' => 'video'],
			'wistia' => ['name' => esc_attr__('Wistia Video', ESG_TEXTDOMAIN), 'type' => 'video'],
			'html5' => ['name' => esc_attr__('HTML5 Video', ESG_TEXTDOMAIN), 'type' => 'video'],
			'soundcloud' => ['name' => esc_attr__('SoundCloud', ESG_TEXTDOMAIN), 'type' => 'play-circled'],
			'alternate-image' => ['name' => esc_attr__('Alternate Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'iframe' => ['name' => esc_attr__('iFrame Markup', ESG_TEXTDOMAIN), 'type' => 'align-justify'],
			'content-image' => ['name' => esc_attr__('First Content Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'content-iframe' => ['name' => esc_attr__('First Content iFrame', ESG_TEXTDOMAIN), 'type' => 'align-justify'],
			'content-html5' => ['name' => esc_attr__('First Content HTML5 Video', ESG_TEXTDOMAIN), 'type' => 'video'],
			'content-youtube' => ['name' => esc_attr__('First Content YouTube Video', ESG_TEXTDOMAIN), 'type' => 'video'],
			'content-vimeo' => ['name' => esc_attr__('First Content Vimeo Video', ESG_TEXTDOMAIN), 'type' => 'video'],
			'content-wistia' => ['name' => esc_attr__('First Content Wistia Video', ESG_TEXTDOMAIN), 'type' => 'video'],
			'content-soundcloud' => ['name' => esc_attr__('First Content SoundCloud', ESG_TEXTDOMAIN), 'type' => 'play-circled']
		];
	...
	public static function get_lb_source_order()
	{
		$media = ['featured-image' => ['name' => esc_attr__('Featured Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			...
			'alternate-image' => ['name' => esc_attr__('Alternate Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'content-image' => ['name' => esc_attr__('First Content Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'post-content' => ['name' => esc_attr__('Post Content', ESG_TEXTDOMAIN), 'type' => 'doc-inv'],
			'revslider' => ['name' => esc_attr__('Slider Revolution', ESG_TEXTDOMAIN), 'type' => 'arrows-ccw'],
			'essgrid' => ['name' => esc_attr__('Essential Grid', ESG_TEXTDOMAIN), 'type' => 'th-large'],
			'soundcloud' => ['name' => esc_attr__('SoundCloud', ESG_TEXTDOMAIN), 'type' => 'soundcloud'],
			'iframe' => ['name' => esc_attr__('iFrame', ESG_TEXTDOMAIN), 'type' => 'link']
		];
	...
	{
		$buttons = ['share' => ['name' => esc_attr__('Social Share', ESG_TEXTDOMAIN), 'type' => 'forward'],
			'slideShow' => ['name' => esc_attr__('Play / Pause', ESG_TEXTDOMAIN), 'type' => 'play'],
			'thumbs' => ['name' => esc_attr__('Thumbnails', ESG_TEXTDOMAIN), 'type' => 'th'],
			'zoom' => ['name' => esc_attr__('Zoom/Pan', ESG_TEXTDOMAIN), 'type' => 'search'],
			'download' => ['name' => esc_attr__('Download Image', ESG_TEXTDOMAIN), 'type' => 'download'],
			'arrowLeft' => ['name' => esc_attr__('Left Arrow', ESG_TEXTDOMAIN), 'type' => 'left'],
			'arrowRight' => ['name' => esc_attr__('Right Arrow', ESG_TEXTDOMAIN), 'type' => 'right'],
			'close' => ['name' => esc_attr__('Close Button', ESG_TEXTDOMAIN), 'type' => 'cancel']
		];
	...
	{
		$media = ['post-content' => ['name' => esc_attr__('Post Content', ESG_TEXTDOMAIN), 'type' => 'doc-text'],
			'youtube' => ['name' => esc_attr__('YouTube Video', ESG_TEXTDOMAIN), 'type' => 'video'],
			'vimeo' => ['name' => esc_attr__('Vimeo Video', ESG_TEXTDOMAIN), 'type' => 'video'],
			'wistia' => ['name' => esc_attr__('Wistia Video', ESG_TEXTDOMAIN), 'type' => 'video'],
			'html5' => ['name' => esc_attr__('HTML5 Video', ESG_TEXTDOMAIN), 'type' => 'video'],
			'soundcloud' => ['name' => esc_attr__('SoundCloud', ESG_TEXTDOMAIN), 'type' => 'video'],
			'featured-image' => ['name' => esc_attr__('Featured Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'alternate-image' => ['name' => esc_attr__('Alternate Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'content-image' => ['name' => esc_attr__('First Content Image', ESG_TEXTDOMAIN), 'type' => 'picture']
		];
	...
	public static function get_poster_source_order()
	{
		$media = ['featured-image' => ['name' => esc_attr__('Featured Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'alternate-image' => ['name' => esc_attr__('Alternate Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'content-image' => ['name' => esc_attr__('First Content Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'youtube-image' => ['name' => esc_attr__('YouTube Thumbnail', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'default-youtube-image' => ['name' => esc_attr__('YouTube Default Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'vimeo-image' => ['name' => esc_attr__('Vimeo Thumbnail', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'default-vimeo-image' => ['name' => esc_attr__('Vimeo Default Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'default-html-image' => ['name' => esc_attr__('HTML5 Default Image', ESG_TEXTDOMAIN), 'type' => 'picture'],
			'no-image' => ['name' => esc_attr__('No Image', ESG_TEXTDOMAIN), 'type' => 'align-justify']
		];
